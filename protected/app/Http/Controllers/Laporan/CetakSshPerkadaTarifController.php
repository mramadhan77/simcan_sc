    ...
    foreach($sshGolongan as $row) {
    	...
    	foreach($sshKelompok as $row2) {
    		...
    		foreach($sshSubKelompok as $row3) {
				...
				// $SshPerkadaTarif = RefSshPerkadaTarif::select('ref_ssh_perkada_tarif.id_tarif_perkada','ref_ssh_tarif.id_sub_kelompok_ssh','ref_ssh_tarif.uraian_tarif_ssh',
				// 'ref_ssh_tarif.uraian_tarif_ssh','ref_ssh_rekening.id_rekening','ref_rek_5.kd_rek_1','ref_rek_5.kd_rek_2','ref_rek_5.kd_rek_3','ref_rek_5.kd_rek_4','ref_rek_5.kd_rek_5',
				// 'ref_rek_5.nama_kd_rek_5','ref_satuan.uraian_satuan','ref_ssh_perkada_tarif.jml_rupiah')
				...
				$SshPerkadaTarif = DB::SELECT('SELECT DISTINCT ref_ssh_perkada_tarif.id_tarif_ssh,ref_ssh_perkada_tarif.id_tarif_perkada,ref_ssh_tarif.id_sub_kelompok_ssh,ref_ssh_tarif.uraian_tarif_ssh,
				ref_ssh_tarif.uraian_tarif_ssh,ref_ssh_rekening.id_rekening,ref_rek_5.kd_rek_1,ref_rek_5.kd_rek_2,ref_rek_5.kd_rek_3,ref_rek_5.kd_rek_4,ref_rek_5.kd_rek_5,
				ref_rek_5.nama_kd_rek_5,ref_satuan.uraian_satuan,ref_ssh_perkada_tarif.jml_rupiah 
				FROM ref_ssh_perkada_tarif
				LEFT JOIN ref_ssh_tarif ON ref_ssh_perkada_tarif.id_tarif_ssh=ref_ssh_tarif.id_tarif_ssh
				LEFT JOIN ref_ssh_rekening ON ref_ssh_tarif.id_tarif_ssh = ref_ssh_rekening.id_tarif_ssh
				LEFT JOIN ref_rek_5 ON ref_ssh_rekening.id_rekening = ref_rek_5.id_rekening
				LEFT JOIN ref_satuan ON ref_ssh_tarif.id_satuan = ref_satuan.id_satuan
				WHERE ref_ssh_tarif.id_sub_kelompok_ssh = '.$row3->id_sub_kelompok_ssh);
