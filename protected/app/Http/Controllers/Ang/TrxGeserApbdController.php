...
class TrxGeserApbdController extends Controller
{
   ...
   public function index(Request $request, Builder $htmlBuilder)
    ...
    public function getDataDokumen()
    {
         $getDataDokumen = DB::SELECT('SELECT (@id:=@id+1) as no_urut, a.id_dokumen_keu, a.jns_dokumen_keu, a.kd_dokumen_keu,a.id_perubahan, a.id_dokumen_ref, 
                    ...
                    WHERE a.jns_dokumen_keu = 1 AND a.kd_dokumen_keu=1');
        ...
        ->addColumn('action', function ($getDataDokumen) {
            ...
            <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li>
                            <a id="btnEditDokumen" class="dropdown-item"><i class="fa fa-pencil fa-fw fa-lg text-warning"></i> Ubah Dokumen APBD Pergeseran</a>
                        </li>
                        <li>
                            <a id="btnProsesLoad" class="dropdown-item"><i class="fa fa-refresh fa-fw fa-lg text-primary"></i> Load Data APBD</a>
                        </li>  
                        <li>
                            <a id="btnLihatRekap" class="dropdown-item"><i class="fa fa-binoculars fa-fw fa-lg text-info"></i> RKAP Data APBD Pergeseran</a>
                        </li>  
                        <li>
                            <a id="btnPostingRkpd" class="dropdown-item"><i class="fa fa-check fa-fw fa-lg text-success"></i> Posting Dokumen APBD Pergeseran</a>
                        </li>                          
                    </ul>
                </div>
            ';
...
public function getDataRekap(Request $req){
    ...
    public function importData(Request $req){
        $dataProgrkpd=DB::INSERT('INSERT INTO trx_anggaran_program (id_dokumen_keu, id_rkpd_ranwal, id_rkpd_final, no_urut, tahun_anggaran, jenis_belanja, id_rkpd_rpjmd, thn_id_rpjmd, id_visi_rpjmd, id_misi_rpjmd, id_tujuan_rpjmd, id_sasaran_rpjmd, id_program_rpjmd, uraian_program_rpjmd, pagu_rkpd, pagu_keuangan, keterangan_program, ket_usulan, status_pelaksanaan, status_data, sumber_data)
            SELECT DISTINCT b.id_dokumen_keu, a.id_rkpd_ranwal, a.id_anggaran_pemda, a.no_urut, a.tahun_anggaran, a.jenis_belanja, a.id_rkpd_rpjmd, a.thn_id_rpjmd, 
            a.id_visi_rpjmd, a.id_misi_rpjmd, a.id_tujuan_rpjmd, a.id_sasaran_rpjmd, a.id_program_rpjmd, a.uraian_program_rpjmd, a.pagu_keuangan, 
			a.pagu_keuangan, a.keterangan_program, a.ket_usulan, 0, 0, 0
            FROM trx_anggaran_program AS a 
            INNER JOIN trx_anggaran_dokumen AS b ON a.id_dokumen_keu = b.id_dokumen_ref
			WHERE (a.status_pelaksanaan <> 2 AND a.status_pelaksanaan <> 3 ) AND b.id_dokumen_ref='.$req->id_dokumen_rkpd);
        if($dataProgrkpd == 0){
            return response ()->json (['pesan'=>'Data Program APBD Final gagal di-Load','status_pesan'=>'0']);
        } else {
            ...
            id_satuan_output, status_data, sumber_data)
                SELECT DISTINCT  a.tahun_anggaran, b.no_urut, a.id_anggaran_pemda, b.id_indikator_program_rkpd, b.id_perubahan, b.kd_indikator, b.uraian_indikator_program_rkpd, b.tolok_ukur_indikator, b.target_keuangan, b.target_keuangan, b.indikator_input, COALESCE(b.target_input,0), b.id_satuan_input, b.indikator_output, b.id_satuan_output, 0, 0 FROM trx_anggaran_indikator AS b 
                INNER JOIN trx_anggaran_program AS a ON a.id_rkpd_final = b.id_anggaran_pemda 
                INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE x.id_dokumen_ref='.$req->id_dokumen_rkpd);
            if($dataIndikatorrkpd == 0){
                return response ()->json (['pesan'=>'Data Indikator Program APBD Final gagal di-Load','status_pesan'=>'0']);
            } else {
                $dataUrusanrkpd=DB::INSERT('INSERT INTO trx_anggaran_urusan (tahun_anggaran, no_urut, id_anggaran_pemda, id_urusan_rkpd_final, id_bidang, sumber_data)
                    SELECT DISTINCT a.tahun_anggaran, b.no_urut, a.id_anggaran_pemda, b.id_urusan_anggaran, b.id_bidang, 0 
                    FROM trx_anggaran_program AS a 
                    INNER JOIN trx_anggaran_urusan AS b ON a.id_rkpd_final = b.id_anggaran_pemda 
                    INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                if($dataUrusanrkpd == 0){
                    return response ()->json (['pesan'=>'Data Urusan Program APBD Final gagal di-Load','status_pesan'=>'0']);
                } else {
                    ...
                    id_urusan_anggaran, id_unit, pagu_rkpd_final, pagu_anggaran, hak_akses, sumber_data, status_pelaksanaan, ket_pelaksanaan, status_data)
                        SELECT DISTINCT a.tahun_anggaran, c.no_urut, a.id_anggaran_pemda, c.id_pelaksana_anggaran, b.id_urusan_anggaran, c.id_unit, c.pagu_anggaran, 
                        c.pagu_anggaran, c.hak_akses, c.sumber_data, c.status_pelaksanaan, c.ket_pelaksanaan, 0
                        FROM trx_anggaran_program AS a
                        INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                        INNER JOIN trx_anggaran_pelaksana AS c ON c.id_urusan_anggaran = b.id_urusan_rkpd_final
                        INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                    if($dataPelaksanarkpd == 0){
                         return response ()->json (['pesan'=>'Data Unit Pelaksana Program APBD Final gagal di-Load','status_pesan'=>'0']);
                    } else {
                        $dataProgpd=DB::INSERT('INSERT INTO trx_anggaran_program_pd (id_pelaksana_anggaran, kd_dokumen_keu, jns_dokumen_keu, id_perubahan, id_dokumen_keu, tahun_anggaran,
                            ...
                            SELECT c.id_pelaksana_anggaran, '.$req->kd_dokumen_keu.', '.$req->jns_dokumen_keu.', '.$req->id_perubahan.', '.$req->id_dokumen_keu.', z.tahun_anggaran, 
                            z.jenis_belanja, z.no_urut, z.id_unit, z.id_program_pd, z.id_program_renstra, z.uraian_program_renstra, z.id_program_ref, z.pagu_anggaran, z.pagu_anggaran, 0,
                            0, z.ket_usulan, 0
                            FROM trx_anggaran_program AS a
                            INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                            INNER JOIN trx_anggaran_pelaksana AS c ON b.id_urusan_anggaran = c.id_urusan_anggaran
                            INNER JOIN trx_anggaran_program_pd AS z ON c.id_pelaksana_rkpd_final = z.id_pelaksana_anggaran
                            INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE  (z.status_pelaksanaan <> 2 AND z.status_pelaksanaan <> 3) AND x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                        if($dataProgpd == 0){
                            return response ()->json (['pesan'=>'Data Program Perangkat Daerah APBD Final gagal di-Load','status_pesan'=>'0']);
                        } else {
                            $dataInprogpd=DB::INSERT('INSERT INTO trx_anggaran_prog_indikator_pd (tahun_anggaran, no_urut, id_program_pd, id_indikator_rkpd_final,
                                ...
                                e.uraian_indikator_program, e.tolok_ukur_indikator, e.target_renja, e.target_renja, e.indikator_output, e.id_satuan_output, e.indikator_input, 
                                ...
                                INNER JOIN trx_anggaran_prog_indikator_pd AS e ON d.id_program_pd_rkpd_final = e.id_program_pd
                                INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                            if($dataInprogpd == 0){
                                return response ()->json (['pesan'=>'Data Indikator Program Perangkat Daerah APBD Final gagal di-Load','status_pesan'=>'0']);
                            } else {
                                $dataKegpd=DB::INSERT('INSERT INTO trx_anggaran_kegiatan_pd (id_kegiatan_pd_rkpd_final, id_program_pd, id_unit, tahun_anggaran, no_urut, id_renja, 
                                    ...
                                    e.id_kegiatan_renstra,e.id_kegiatan_ref,e.uraian_kegiatan_forum,e.pagu_forum,e.pagu_forum,
                                    e.pagu_plus1_forum,e.pagu_plus1_forum,e.pagu_forum,e.keterangan_status,0,e.status_pelaksanaan,0,"" as kelompok_sasaran 
                                    FROM trx_anggaran_program AS a
                                    INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                                    INNER JOIN trx_anggaran_pelaksana AS c ON b.id_urusan_anggaran = c.id_urusan_anggaran
                                    INNER JOIN trx_anggaran_program_pd AS d ON c.id_pelaksana_anggaran = d.id_pelaksana_anggaran
                                    INNER JOIN trx_anggaran_kegiatan_pd AS e ON d.id_program_pd_rkpd_final = e.id_program_pd
                                        INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu
                                    WHERE  (e.status_pelaksanaan <> 2 AND e.status_pelaksanaan <> 3) AND  x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                                if($dataKegpd == 0){
                                    return response ()->json (['pesan'=>'Data Kegiatan Perangkat Daerah APBD Final gagal di-Load','status_pesan'=>'0']);
                                } else {
                                    $dataInkegpd=DB::INSERT('INSERT INTO trx_anggaran_keg_indikator_pd (tahun_anggaran, no_urut, id_kegiatan_pd, id_indikator_rkpd_final, 
                                        ...
                                        SELECT e.tahun_anggaran, f.no_urut, e.id_kegiatan_pd, f.id_indikator_kegiatan, 0,
                                        f.kd_indikator, f.uraian_indikator_kegiatan, f.tolok_ukur_indikator, f.target_renja, f.target_renja, 
                                        f.indikator_output, f.id_satuan_output, f.indikator_input,f.target_input, f.id_satuan_input, 0, 0
                                        FROM trx_anggaran_program AS a
                                        INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                                        INNER JOIN trx_anggaran_pelaksana AS c ON b.id_urusan_anggaran = c.id_urusan_anggaran
                                        INNER JOIN trx_anggaran_program_pd AS d ON c.id_pelaksana_anggaran = d.id_pelaksana_anggaran
                                        INNER JOIN trx_anggaran_kegiatan_pd AS e ON d.id_program_pd = e.id_program_pd
                                        INNER JOIN trx_anggaran_keg_indikator_pd AS f ON e.id_kegiatan_pd_rkpd_final = f.id_kegiatan_pd
                                        INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu 
                                        WHERE x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                                    if($dataInkegpd == 0){
                                        return response ()->json (['pesan'=>'Data Indikator Kegiatan Perangkat Daerah APBD Final gagal di-Load','status_pesan'=>'0']);
                                    } else {
                                        $dataPelSubUnit=DB::INSERT('INSERT INTO trx_anggaran_pelaksana_pd (tahun_anggaran, no_urut, id_kegiatan_pd, id_pelaksana_rkpd_final, id_sub_unit, 
                                            ...
                                            INNER JOIN trx_anggaran_program_pd AS d ON c.id_pelaksana_anggaran = d.id_pelaksana_anggaran
                                            INNER JOIN trx_anggaran_kegiatan_pd AS e ON d.id_program_pd = e.id_program_pd
                                            INNER JOIN trx_anggaran_pelaksana_pd AS f ON e.id_kegiatan_pd_rkpd_final = f.id_kegiatan_pd
                                            INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE f.status_pelaksanaan <> 1 AND  x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                                        if($dataPelSubUnit == 0){
                                            return response ()->json (['pesan'=>'Data Sub Unit Pelaksana Kegiatan APBD Final gagal di-Load','status_pesan'=>'0']);
                                        } else {
                                            $dataAktivitas=DB::INSERT('INSERT INTO trx_anggaran_aktivitas_pd 
                                                ...
                                                g.id_program_nasional, g.id_program_provinsi, g.uraian_aktivitas_kegiatan, g.volume_rkpd_1, g.volume_rkpd_1, g.id_satuan_1, g.volume_rkpd_2, 
                                                g.volume_rkpd_2, g.id_satuan_2, g.jenis_kegiatan, g.pagu_anggaran, g.pagu_anggaran, 0 as status_data, g.status_pelaksanaan, g.keterangan_aktivitas, g.group_keu, 0 as sumber_data, g.id_satuan_publik 
                                                FROM trx_anggaran_program AS a
                                                INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                                                INNER JOIN trx_anggaran_pelaksana AS c ON b.id_urusan_anggaran = c.id_urusan_anggaran
                                                INNER JOIN trx_anggaran_program_pd AS d ON c.id_pelaksana_anggaran = d.id_pelaksana_anggaran
                                                INNER JOIN trx_anggaran_kegiatan_pd AS e ON d.id_program_pd = e.id_program_pd
                                                INNER JOIN trx_anggaran_pelaksana_pd AS f ON e.id_kegiatan_pd = f.id_kegiatan_pd
                                                INNER JOIN trx_anggaran_aktivitas_pd AS g ON f.id_pelaksana_rkpd_final = g.id_pelaksana_pd
                                                INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE  g.status_pelaksanaan <> 1 AND x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                                            if($dataAktivitas == 0){
                                                return response ()->json (['pesan'=>'Data Aktivitas Perangkat Daerah Kegiatan APBD Final gagal di-Load','status_pesan'=>'0']);
                                            } else {
                                                $dataLokasi=DB::INSERT('INSERT INTO trx_anggaran_lokasi_pd (id_lokasi_rkpd_final, id_aktivitas_pd, tahun_anggaran, no_urut, jenis_lokasi, 
                                                        ...
                                                        SELECT h.id_lokasi_pd,  g.id_aktivitas_pd, g.tahun_anggaran, h.no_urut, h.jenis_lokasi, h.id_lokasi, h.id_lokasi_teknis, h.volume_usulan_1, 
                                                        h.volume_usulan_1, h.volume_usulan_2, h.volume_usulan_2, h.id_satuan_1, h.id_satuan_2, h.id_desa, h.id_kecamatan, h.rt, h.rw, h.uraian_lokasi, h.lat, h.lang, 0, 0, h.ket_lokasi,0    
                                                        FROM trx_anggaran_program AS a
                                                        INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                                                        INNER JOIN trx_anggaran_pelaksana AS c ON b.id_urusan_anggaran = c.id_urusan_anggaran
                                                        INNER JOIN trx_anggaran_program_pd AS d ON c.id_pelaksana_anggaran = d.id_pelaksana_anggaran
                                                        ...
                                                        INNER JOIN trx_anggaran_pelaksana_pd AS f ON e.id_kegiatan_pd = f.id_kegiatan_pd
                                                        INNER JOIN trx_anggaran_aktivitas_pd AS g ON f.id_pelaksana_pd = g.id_pelaksana_pd
                                                        INNER JOIN trx_anggaran_lokasi_pd AS h ON g.id_aktivitas_rkpd_final = h.id_aktivitas_pd
                                                        INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE  h.status_pelaksanaan NOT IN (2,3,4)  AND x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                                                if($dataLokasi == 0){
                                                    return response ()->json (['pesan'=>'Data Lokasi Aktivitas Kegiatan APBD Final gagal di-Load','status_pesan'=>'0']);
                                                } else {
                                                    $dataBelanja=DB::INSERT('INSERT INTO trx_anggaran_belanja_pd (id_aktivitas_pd, id_belanja_rkpd_final, tahun_anggaran, no_urut, id_zona_ssh, 
                                                            ...
                                                            SELECT g.id_aktivitas_pd, h.id_belanja_pd, g.tahun_anggaran, h.no_urut, h.id_zona_ssh, h.sumber_belanja, h.id_aktivitas_asb, 
                                                            h.id_item_ssh, h.id_rekening_ssh, h.uraian_belanja, h.volume_1, h.id_satuan_1, h.volume_2, h.id_satuan_2,h.koefisien, 
                                                            h.harga_satuan, h.jml_belanja, h.volume_1, h.volume_2, h.koefisien, h.harga_satuan, h.jml_belanja, 0, 0
                                                            FROM trx_anggaran_program AS a
                                                            INNER JOIN trx_anggaran_urusan AS b ON a.id_anggaran_pemda = b.id_anggaran_pemda
                                                            INNER JOIN trx_anggaran_pelaksana AS c ON b.id_urusan_anggaran = c.id_urusan_anggaran
                                                            INNER JOIN trx_anggaran_program_pd AS d ON c.id_pelaksana_anggaran = d.id_pelaksana_anggaran
                                                            ...
                                                            INNER JOIN trx_anggaran_pelaksana_pd AS f ON e.id_kegiatan_pd = f.id_kegiatan_pd
                                                            INNER JOIN trx_anggaran_aktivitas_pd AS g ON f.id_pelaksana_pd = g.id_pelaksana_pd
                                                            INNER JOIN trx_anggaran_belanja_pd AS h ON g.id_aktivitas_rkpd_final = h.id_aktivitas_pd
                                                            INNER JOIN trx_anggaran_dokumen AS x ON a.id_dokumen_keu = x.id_dokumen_keu WHERE x.id_dokumen_ref='.$req->id_dokumen_rkpd);
                                                    if($dataBelanja == 0){
                                                        return response ()->json (['pesan'=>'Data Rincian Belanja APBD Final gagal di-Load','status_pesan'=>'0']);
                                                    } else {
                                                        return response ()->json (['pesan'=>'Data Awal APBD Perubahan Berhasil di-Load','status_pesan'=>'1']);
                                                    }
                                                } 
                                            } 
                                        }
    ...
    {
        $dataDokumen = DB::SELECT('SELECT a.id_dokumen_keu, a.jns_dokumen_keu, a.kd_dokumen_keu,a.id_perubahan, a.id_dokumen_ref, 
            a.tahun_anggaran, a.nomor_keu, a.tanggal_keu, a.uraian_perkada, a.id_unit_ppkd, a.jabatan_tandatangan, 
            a.nama_tandatangan, a.nip_tandatangan, a.flag, a.created_at, a.updated_at,
            CONCAT("No:",a.nomor_keu," (Tahun Anggaran:",a.tahun_anggaran,")") as nomor_display 
            FROM trx_anggaran_dokumen AS a
            WHERE a.jns_dokumen_keu = 1 AND (a.kd_dokumen_keu=0 OR a.kd_dokumen_keu=1) AND a.tahun_anggaran = '.$req->tahun.' AND a.flag = 1');
     ...
     public function addDokumen(Request $req)
    {
        try{
            ...
            $data->jns_dokumen_keu = 1;
            $data->kd_dokumen_keu = 1;
            $data->id_perubahan = 0;
    ...
    {
        $result = TrxAnggaranDokumen::where('id_dokumen_keu',$req->id_dokumen_keu)->delete();   
        if($result != 0){
    ...
    {
        $cek = DB::SELECT('SELECT COUNT(id_dokumen_ref) AS jml FROM trx_anggaran_dokumen
            WHERE jns_dokumen_keu = 1 AND kd_dokumen_keu = 2 AND tahun_anggaran = '.$req->tahun_anggaran.'
            AND id_dokumen_ref = '.$req->id_dokumen_ref.'
            GROUP BY id_dokumen_ref');

        if($cek != null && $cek[0]->jml > 0 ){            
            $data = DB::UPDATE('UPDATE trx_anggaran_dokumen SET flag ='.$req->flag.' WHERE kd_dokumen_keu=0 AND jns_dokumen_keu=1 AND tahun_anggaran='.$req->tahun_anggaran.' AND id_dokumen_keu='.$req->id_dokumen_keu);       
            if($data != 0){
                $dataProg=DB::UPDATE('UPDATE trx_anggaran_program SET status_data ='.$req->status.' WHERE tahun_anggaran='.$req->tahun_anggaran.'AND id_dokumen_keu='.$req->id_dokumen_keu.' AND status_data='.$req->status_awal);
                if($dataProg != 0){
