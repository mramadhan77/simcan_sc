...
class TrxGeserApbdRkpdController extends Controller
{
    ...
    public function getDokumenKeuangan(Request $req){
        $getDataDokumen = DB::SELECT('SELECT (@id:=@id+1) as no_urut, a.id_dokumen_keu, a.jns_dokumen_keu, a.kd_dokumen_keu,a.id_perubahan, a.id_dokumen_ref, 
                ...
                WHERE a.jns_dokumen_keu = 1 AND a.kd_dokumen_keu = 1 AND a.tahun_anggaran ='.$req->tahun);
    ...
    {
      $indikatorRKPD=DB::select('SELECT a.tahun_rkpd,(@id:=@id+1) as urut, a.no_urut, a.id_anggaran_pemda,a.id_indikator_program_rkpd,a.id_perubahan,a.kd_indikator,a.uraian_indikator_program_rkpd,a.id_indikator_rkpd_final,
        a.tolok_ukur_indikator,a.target_keuangan,a.target_rkpd,a.status_data,a.sumber_data,a.indikator_output,a.id_satuan_output, b.status_data as status_data_program,b.status_pelaksanaan as status_program,
        CASE a.status_data
            WHEN 0 THEN "fa fa-question"
            WHEN 1 THEN "fa fa-check-square-o"
        END AS status_reviu,
    ...
    public function getPelaksanaRKPD($id_rkpd,$id_urusan)
    {
      $pelaksanaRKPD=DB::select('SELECT (@id:=@id+1) as urut, a.no_urut, a.id_pelaksana_anggaran, a.id_unit,a.tahun_anggaran,a.id_anggaran_pemda,
            ...
            IF(a.sumber_data=0,"APBD","Baru") as keterangan,b.kd_unit,b.nm_unit,a.sumber_data,a.status_pelaksanaan, a.hak_akses, a.ket_pelaksanaan,
    ...
    public function addIndikatorRKPD(Request $req){
        ...
        // if($CekProgram == true){
            ...
            $data->id_indikator_rkpd_final=0; 
            $data->id_perubahan=0;
            ...
            $data->target_rkpd=0; 
            $data->target_keuangan=$req->target_keuangan; 
            $data->status_data=0;
            $data->sumber_data=1; 
            $data->indikator_input=Null;
            $data->target_input=0;
            $data->id_satuan_input=Null;
            $data->indikator_output=0;
