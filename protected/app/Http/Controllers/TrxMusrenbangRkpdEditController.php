...
class TrxMusrenbangRkpdEditController extends Controller
{
    ...
    {
       $CheckProgram=DB::SELECT('SELECT status_pelaksanaan, status_data FROM trx_musrenkab WHERE id_musrenkab = '.$id_program.' LIMIT 1');
    ...
    public function getCekProgram($id_ranwal){
        ...
        $CheckProgram=DB::SELECT('SELECT a.id_musrenkab, a.pagu_rpjmd, a.pagu_ranwal,  
            COALESCE((SELECT COUNT(*) AS jml_indi FROM trx_musrenkab_indikator b
                WHERE b.tahun_rkpd=a.tahun_rkpd AND b.id_musrenkab=a.id_musrenkab
                GROUP BY b.tahun_rkpd, b.id_musrenkab),0) as jml_indikator, 
            COALESCE((SELECT COUNT(*) AS jml_indi FROM trx_musrenkab_indikator b
                WHERE b.tahun_rkpd=a.tahun_rkpd AND b.id_musrenkab=a.id_musrenkab AND b.status_data=1
                GROUP BY b.tahun_rkpd, b.id_musrenkab),0) as indikator_0, 
            COALESCE((SELECT COUNT(*) AS jml_indi FROM trx_musrenkab_pelaksana b
                WHERE b.tahun_rkpd=a.tahun_rkpd AND b.id_musrenkab=a.id_musrenkab
                GROUP BY b.tahun_rkpd, b.id_musrenkab),0) as jml_unit, 
            COALESCE((SELECT COUNT(*) AS jml_indi FROM trx_musrenkab_pelaksana b
                WHERE b.tahun_rkpd=a.tahun_rkpd AND b.id_musrenkab=a.id_musrenkab AND b.status_data=1
                GROUP BY b.tahun_rkpd, b.id_musrenkab),0) as unit_0,
            COALESCE((SELECT SUM(d.pagu_forum) FROM trx_musrenkab_program_pd d
                ...
                WHERE b.id_musrenkab = a.id_musrenkab AND (d.status_pelaksanaan <> 2 AND d.status_pelaksanaan <> 3)
                GROUP BY b.id_musrenkab),0) AS pagu_prog_renja        
            FROM trx_musrenkab AS a
            WHERE a.id_musrenkab = '.$id_ranwal.' LIMIT 1');
    ...
    public function getCekIndikkator($id_ranwal){
        $cek=DB::SELECT('SELECT SUM(CASE WHEN a.status_data = 0 then 1 else 0 end) as jml_target FROM trx_musrenkab_indikator a 
            WHERE a.id_musrenkab='.$id_ranwal.' GROUP BY a.id_musrenkab');
    ...
    {   
        $dataranwal=DB::Select('SELECT (@id:=@id+1) as urut,a.* FROM (SELECT a.id_musrenkab, a.id_rkpd_ranwal, a.id_rkpd_rancangan, a.no_urut, a.tahun_rkpd, a.jenis_belanja, a.id_rkpd_rpjmd, 
        ...
        COALESCE((SELECT COUNT(*) AS jml_indi FROM trx_musrenkab_pelaksana b
            WHERE b.tahun_rkpd=a.tahun_rkpd AND b.id_musrenkab=a.id_musrenkab AND b.status_data=1
            GROUP BY b.tahun_rkpd, b.id_musrenkab),0) as unit_0, b.no_urut as no_misi, 
    ...
    {
      $indikatorRKPD=DB::select('SELECT a.tahun_rkpd,(@id:=@id+1) as urut, a.no_urut, a.id_musrenkab,a.id_indikator_program_rkpd,a.id_perubahan,a.kd_indikator,a.uraian_indikator_program_rkpd,a.id_indikator_rkpd,
          ...
          CASE a.status_data
              ...
              WHEN 1 THEN "green"
          END AS warna  
            FROM trx_musrenkab_indikator a
            INNER JOIN trx_musrenkab b ON a.id_musrenkab = b.id_musrenkab AND a.tahun_rkpd = b.tahun_rkpd,(SELECT @id:=0) x where a.id_musrenkab='.$id_rkpd);
    ...
    public function getUrusanRKPD($id_rkpd)
    {
      $urusanRKPD=DB::select('SELECT (@id:=@id+1) as urut, x.* FROM ( 
                 SELECT a.tahun_rkpd, a.no_urut, a.id_musrenkab,a.id_urusan_rkpd, a.id_bidang, b.kd_bidang, b.nm_bidang, 
                ...
                FROM trx_musrenkab_urusan a
                INNER JOIN ref_bidang b on a.id_bidang = b.id_bidang
                INNER JOIN ref_urusan c on b.kd_urusan = c.kd_urusan
                INNER JOIN trx_musrenkab d on a.id_musrenkab = d.id_musrenkab
                LEFT OUTER JOIN (SELECT a.tahun_rkpd, a.id_musrenkab, a.id_urusan_rkpd,COUNT(*) as jml_data, b.jml_0
                FROM trx_musrenkab_pelaksana a
                LEFT OUTER JOIN (SELECT tahun_rkpd, id_musrenkab, id_urusan_rkpd, COUNT(*) as jml_0
                FROM trx_musrenkab_pelaksana
                WHERE status_data= 1
                GROUP BY tahun_rkpd, id_musrenkab,id_urusan_rkpd) b ON a.tahun_rkpd=b.tahun_rkpd AND a.id_musrenkab = b.id_musrenkab AND a.id_urusan_rkpd = b.id_urusan_rkpd
                GROUP BY a.tahun_rkpd,a.id_musrenkab, a.id_urusan_rkpd, b.jml_0) e ON a.tahun_rkpd=e.tahun_rkpd AND a.id_musrenkab = e.id_musrenkab AND a.id_urusan_rkpd = e.id_urusan_rkpd) x, 
                (SELECT @id:=0) var_no where x.id_musrenkab='.$id_rkpd.' order By kd_urusan, kd_bidang');
    ...
    {
      $pelaksanaRKPD=DB::select('SELECT (@id:=@id+1) as urut, a.no_urut, a.id_pelaksana_rkpd, a.id_unit,a.tahun_rkpd,a.id_musrenkab,
            ...
            END AS warna,
            COALESCE((SELECT SUM(d.pagu_forum) FROM trx_musrenkab_program_pd d
            WHERE d.id_pelaksana_rkpd = a.id_pelaksana_rkpd AND d.id_unit = a.id_unit AND (d.status_pelaksanaan <> 2 AND d.status_pelaksanaan <> 3)
            GROUP BY d.id_pelaksana_rkpd,d.id_unit),0) AS pagu_prog_renja   
            FROM trx_musrenkab_pelaksana AS a
            INNER JOIN trx_musrenkab c ON a.id_musrenkab = c.id_musrenkab AND a.tahun_rkpd = c.tahun_rkpd 
            INNER JOIN ref_unit AS b ON a.id_unit = b.id_unit,(SELECT @id:=0) var_no where a.id_musrenkab='.$id_rkpd.' AND a.id_urusan_rkpd='.$id_urusan);
    ...
    // $cek = DB::SELECT('SELECT tahun_rkpd, flag FROM trx_musrenkab_dokumen WHERE tahun_rkpd = '.session::get('tahun').' LIMIT 1');
           $data = new TrxMusrenkab();
    ...
    {
        $CekProgram=$this->CheckStatusProgram($req->id_musrenkab);
        if($CekProgram == true){
            try{    
                $data = TrxMusrenkab::find($req->id_musrenkab);
                $data->no_urut = $req->no_urut ;
                $data->uraian_program_rpjmd = $req->uraian_program_rpjmd ;
                $data->jenis_belanja = $req->jenis_belanja ;
                $data->thn_id_rpjmd = $req->thn_id_rpjmd ;
    ...
    public function postProgram(Request $req)
    {
        ...
        $data = TrxMusrenkab::find($req->id_rkpd_ranwal);
        $data->status_data = $req->status_data ;
    ...
    public function hapusProgramRKPD(Request $req)
      {
        $CekProgram=$this->CheckStatusProgram($req->id_musrenkab);
        if($CekProgram == true){
            TrxMusrenkab::where('id_musrenkab',$req->id_musrenkab)->delete ();
    ...
    public function addIndikatorRKPD(Request $req){
        ...
        if($CekProgram == true){
            $data= new TrxMusrenkabIndikator();
            $data->tahun_rkpd=session::get('tahun') ; 
            $data->no_urut=$req->no_urut; 
            $data->id_musrenkab=$req->id_musrenkab;
    ...
    public function editIndikatorRKPD(Request $req)
    {
        $CekProgram=$this->CheckStatusProgram($req->id_musrenkab);
            ...
            $data= TrxMusrenkabIndikator::find($req->id_indikator_rkpd);
            $data->no_urut=$req->no_urut; 
            $data->kd_indikator=$req->kd_indikator; 
            $data->uraian_indikator_program_rkpd=$req->uraian_indikator; 
            $data->tolok_ukur_indikator=$req->tolok_ukur_indikator;
    ...
    public function postIndikatorRKPD(Request $req){
        try{     
            $data= TrxMusrenkabIndikator::find($req->id_indikator_program_rkpd);        
    ...
    {
        TrxMusrenkabIndikator::where('id_indikator_rkpd',$req->id_indikator_program_rkpd)->delete ();
    ...
    public function addUrusanRKPD(Request $req){
        ...
        if($CekProgram == true){
            try{
                $data = new TrxMusrenkabUrusan();
                $data->no_urut = $req->no_urut ;
                $data->tahun_rkpd = session::get('tahun') ;
                $data->id_musrenkab = $req->id_rkpd_ranwal ;
    ...
    public function hapusUrusanRKPD(Request $req){
      ...
      if($cek == NULL || $cek[0]->jml_pelaksana == 0){
        TrxMusrenkabUrusan::where('id_urusan_rkpd',$req->id_urusan_rkpd)->delete ();
        return response ()->json (['pesan'=>'Data Berhasil Dihapus','status_pesan'=>'1']);
      } else {
    ...
    try{
           $data = new TrxMusrenkabPelaksana();
           $data->no_urut = $req->no_urut ;
           $data->tahun_rkpd = session::get('tahun') ;
    ...
    public function editPelaksanaRKPD(Request $req){
        ...
        $data = TrxMusrenkabPelaksana::find($req->id_pelaksana_rkpd);
        $data->no_urut = $req->no_urut ;
        $data->id_unit = $req->id_unit ;
        $data->hak_akses=$req->hak_akses;
        $data->status_data=$req->status_data;
    ...
    public function postPelaksanaRKPD(Request $req){ 
        ...
        $cekpagu = DB::SELECT('SELECT x.id_pelaksana_rkpd, 
                ...
                FROM trx_musrenkab_pelaksana x 
                LEFT OUTER JOIN (SELECT a.id_pelaksana_rkpd, SUM(a.pagu_forum) AS pagu_program FROM trx_musrenkab_program_pd a 
                WHERE a.status_pelaksanaan <> 2 AND a.status_pelaksanaan <> 3 AND a.status_data=1
                GROUP BY a.id_pelaksana_rkpd, a.status_data) a ON x.id_pelaksana_rkpd = a. id_pelaksana_rkpd
                LEFT OUTER JOIN (SELECT b.id_pelaksana_rkpd, SUM(b.pagu_forum)  AS pagu_forum FROM 
                (SELECT p.id_pelaksana_rkpd, a.pagu_forum FROM trx_musrenkab_kegiatan_pd a 
                INNER JOIN trx_musrenkab_program_pd p ON a.id_program_pd = p.id_program_pd
                ...
                GROUP BY b.id_pelaksana_rkpd) b ON x.id_pelaksana_rkpd=b.id_pelaksana_rkpd
                LEFT OUTER JOIN (SELECT c.id_pelaksana_rkpd, SUM(c.pagu_aktivitas_forum) AS pagu_aktivitas_forum FROM 
                (SELECT p.id_pelaksana_rkpd, y.pagu_aktivitas_forum  FROM trx_musrenkab_aktivitas_pd y 
                INNER JOIN trx_musrenkab_pelaksana_pd z ON y.id_pelaksana_pd = z.id_pelaksana_pd
                INNER JOIN trx_musrenkab_kegiatan_pd x ON z.id_kegiatan_pd = x.id_kegiatan_pd 
                INNER JOIN trx_musrenkab_program_pd p ON x.id_program_pd = p.id_program_pd
                ...
                GROUP BY c.id_pelaksana_rkpd) c ON x.id_pelaksana_rkpd=c.id_pelaksana_rkpd
                LEFT OUTER JOIN (SELECT d.id_pelaksana_rkpd, SUM(d.jml_belanja_forum) AS jml_belanja_forum FROM 
                (SELECT p.id_pelaksana_rkpd, w.jml_belanja_forum  FROM trx_musrenkab_belanja_pd w
                INNER JOIN trx_musrenkab_aktivitas_pd y ON w.id_aktivitas_pd = y.id_aktivitas_pd
                INNER JOIN trx_musrenkab_pelaksana_pd z ON y.id_pelaksana_pd = z.id_pelaksana_pd
                INNER JOIN trx_musrenkab_kegiatan_pd x ON z.id_kegiatan_pd = x.id_kegiatan_pd 
                INNER JOIN trx_musrenkab_program_pd p ON x.id_program_pd = p.id_program_pd
                ...
                GROUP BY d.id_pelaksana_rkpd) d ON x.id_pelaksana_rkpd=d.id_pelaksana_rkpd
    ...
    {
        $cek = DB::SELECT('SELECT COUNT(*) AS jml_data FROM trx_musrenkab_program_pd WHERE id_pelaksana_rkpd='.$req->id_pelaksana_rkpd);
        if($cek == NULL || $cek[0]->jml_data == 0){
            TrxMusrenkabPelaksana::where('id_pelaksana_rkpd',$req->id_pelaksana_rkpd)->delete ();
            return response ()->json (['pesan'=>'Data Berhasil Dihapus','status_pesan'=>'1'] );
        } else {
