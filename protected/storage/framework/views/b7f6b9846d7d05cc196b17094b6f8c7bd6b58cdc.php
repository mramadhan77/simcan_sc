        ...
        <div class="row">
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="our-services-wrapper mb-60">
                        <a href="<?php echo e(url('/ssh')); ?>" style="text-decoration:none;">
                        <div class="services-inner">
                            <div class="our-services-img">
                                <img src="<?php echo e('../assets/images/price-tag.png'); ?>" width="68px" alt="">
                            </div>
                ...
                <div class="col-xl-6 col-lg-6 col-md-6 col-sm-12">
                    <div class="our-services-wrapper mb-60">
                    <a href="<?php echo e(url('/asb/aktivitas')); ?>" style="text-decoration:none;">
                        <div class="services-inner">
                            <div class="our-services-img">
                                <img src="<?php echo e('../assets/images/cart_1.png'); ?>" width="68px" alt="">
                            </div>
                            <div class="our-services-text">
