      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          ...
          <div class="panel-body">
            <form class="form-horizontal" role="form" autocomplete='off' action="<?php echo e(url('/ranwalrkpd/prosesTransferData/')); ?>" method="" >
...
function loadReProses(){
  ReProses_Tbl = $('#tblReProses').DataTable({
        ...
        serverSide: true,
        "autoWidth": false,
        "ajax": {"url": "./getRePostingData/"+<?php echo e(Session::get('tahun')); ?>},
        "language": {
                "decimal": ",",
                "thousands": "."},
        'columnDefs': [
...
var progrkpd = $('#tblProgramRKPD').DataTable({
        ...
        serverSide: true,
        "autoWidth": false,
        "ajax": {"url": "./getDataRekap/"+<?php echo e(Session::get('tahun')); ?>},
        "language": {
                "decimal": ",",
                "thousands": "."},
        // 'columnDefs': [
