        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <p><h2 id="judul" class="panel-title"> <?php echo e($this->title); ?> :: Penyesuaian Perangkat Daerah</h2></p>
                </div>
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="tahun_rkpd" class="col-sm-3 control-label text-left" align='left'>Tahun Perencanaan :</label>
                        <div class="col-sm-2">                            
                            <input class="form-control text-center" type="text" id="tahun_rkpd" name="tahun_rkpd" value="<?php echo e(Session::get('tahun')); ?>" disabled>
                        </div>
                </div>
                <div class="form-group">
                                  ...
                                  <div class="table-responsive">
                                    ...
                                    <table id="tblKegiatanRenja" class="table table-striped table-bordered table-responsive compact" width="100%">
                                        <thead>
                                            ...
                                            <tr>
                                                <th width='10%' style="text-align: center; vertical-align:middle">Rancangan RKPD</th>
...
<script id="details-template" type="text/x-handlebars-template">
        <table class="table table-striped table-bordered table-responsive compact details-table" id="bidang-{{id_unit}}{{id_musrenkab}}">
            <thead>
              <tr>
...
<script id="details-inKeg" type="text/x-handlebars-template">
  ...
  <?php echo $__env->make('musrenrkpd.program_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.program_indikator_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.kegiatan_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.kegiatan_indikator_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.pelaksana_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.aktivitas_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.lokasi_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.belanja_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('musrenrkpd.cariProgramRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariKegiatanRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariProgramRef', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariKegiatanRef', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariSubUnit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariAktivitasASB', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariLokasiModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariLokasiTeknisModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariItemSSH', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.cariRekening', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.ModalCopyBelanja', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('musrenrkpd.loadBelanjaASB', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
  <?php echo $__env->make('musrenrkpd.js_penyesuaian_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php $__env->stopSection(); ?>
