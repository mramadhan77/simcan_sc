            ...
            <div class="">
                    <table id="tblProgram" class="table compact table-responsive table-striped table-bordered display"  cellspacing="0" width="100%">
                      <thead>
                          ...
                          <tr>
                          <?php $__currentLoopData = $dataperda; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $datas): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                              <th width="5%" style="text-align: center"><?php echo e($datas->tahun_1); ?></th>
                              <th width="5%" style="text-align: center"><?php echo e($datas->tahun_2); ?></th>
                              <th width="5%" style="text-align: center"><?php echo e($datas->tahun_3); ?></th>
                              <th width="5%" style="text-align: center"><?php echo e($datas->tahun_4); ?></th>
                              <th width="5%" style="text-align: center"><?php echo e($datas->tahun_5); ?></th>
...
<?php echo $__env->make('renstra.FrmRenstraVisi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraMisi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraTujuan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraTujuanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraSasaran', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraSasaranIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraStrategi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraKebijakan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraProgram', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraKegiatan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraKegiatanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('renstra.FrmRenstraKegiatanPelaksana', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariSasaranRPJMD', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariItemRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariSasaranIndikatorRpjmd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariSasaranIndikatorRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariItemRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariProgramRef', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('bebas.FrmCariKegiatanRef', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
<?php echo $__env->make('renstra.JsRenstraVisi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraMisi', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraTujuan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraTujuanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraSasaran', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraSasaranIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraProgram', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraKegiatan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make('renstra.JsRenstraKegiatanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
