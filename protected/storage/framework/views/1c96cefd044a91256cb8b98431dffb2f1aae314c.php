      ...
      <div class="col-md-12">
        <div class="panel panel-warning">
          ...
          <ul class="nav nav-tabs" role="tablist">
            ...
            <li><a href="#program" aria-controls="program" role="tab" data-toggle="tab">Kegiatan</a></li>
          </ul>
          ...
          <div class="tab-content">
            ...
            <div role="tabpanel" class="tab-pane" id="sasaran">
              ...
              <form name="" class="form-horizontal" role="form" autocomplete='off' action="" method="post">
              <div class="form-group">
                  <label for="cb_dok_perkin" class="col-sm-2 control-label" align='left'>Dokumen Perkin Eselon 2</label>
                  <div class="col-sm-9">
                ...
                <table id="tblProgram" class="table display table-striped table-bordered table-responsive"  cellspacing="0" width="100%">
                  <thead>
                      <tr>
                          ...
                          <th width="15%" style="text-align: center; vertical-align:middle">Pagu Kegiatan</th>
                          <th width="20%" style="text-align: center; vertical-align:middle">Pelaksana Kegiatan</th>
                          <th width="50px" style="text-align: center; vertical-align:middle">Aksi</th>
                      </tr>
                  </thead>
                  <tbody>
...
<script id="details-inSasaran" type="text/x-handlebars-template">
  <table class="table table-striped display table-bordered table-responsive compact details-table" id="inSasaran-{{id_perkin_program}}">
      <thead>
        <tr>
...
<?php echo $__env->make('kin.perkin.es3.FrmPerkinDokumen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('kin.perkin.es3.FrmPerkinProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('kin.perkin.es3.FrmPerkinKegiatan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
...
$('#tblDokPerkin tbody').on( 'dblclick', 'tr', function () {
  var data = tblDokPerkin.row(this).data();
    ...
    $.ajax({
        type: "GET",
        url: 'es3/getDokumenEs2/'+id_eselon2_temp+'/'+id_tahun_temp,
        dataType: "json",
        success: function(data) {
          var j = data.length;
          var post, i;
...
function loadSasaran($id_dokumen) {
  ...
  $('#tblSasaran tbody').on('click', 'td.details-control', function () {
      ...
      var tableId = 'inSasaran-' + row.data().id_perkin_program;
...
$('#tblSasaran tbody').on( 'dblclick', 'tr', function () {
    ...
    id_perkin_sasaran_temp =  data.id_perkin_program;   
    
    $('.nav-tabs a[href="#program"]').tab('show');
    loadProgram(id_perkin_sasaran_temp);
    $.ajax({
        type: "GET",
        url: 'es3/getEselon4/'+id_eselon3_temp,
        dataType: "json",
        success: function(data) {
          var j = data.length;
          var post, i;
  ...
  tblProgram = $('#tblProgram').DataTable( {
          ...
          language: {
                "decimal": ",",
                "thousands": "."},
          "ajax": {"url": "./es3/getProgram/"+$id_perkin_sasaran},
          "language": {
                "decimal": ",",
                "thousands": "."},
          "columns": [
  ...
  $( ".cb_eselon_3" ).change(function() {    
    ...
    $.ajax({
        ...
        success: function(data) {
          ...
          $('select[name="cb_eselon_3a"]').empty();
          $('select[name="cb_eselon_3a"]').append('<option value="-1">---Pilih Jabatan Bidang/Bagian---</option>');

          for (i = 0; i < j; i++) {
            post = data[i];
            $('select[name="cb_eselon_3a"]').append('<option value="'+ post.id_sotk_es3 +'">'+ post.nama_eselon +'</option>');
          }
        }
    });
  });
...
<?php echo $__env->make('kin.perkin.es3.JsPerkinDokumen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('kin.perkin.es3.JsPerkinProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
<?php echo $__env->make('kin.perkin.es3.JsPerkinKegiatan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
});
</script>
<?php $__env->stopSection(); ?>
