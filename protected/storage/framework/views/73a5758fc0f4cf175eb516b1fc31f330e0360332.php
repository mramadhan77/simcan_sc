        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" >
                ...
                <input type="hidden" class="form-control" id="id_perkin_dokumen_program" name="id_perkin_dokumen_program" readonly>
                ...
                <div class="form-group"> 
                  <label class="control-label col-sm-12" style="text-align: left;">Rincian Pagu Program :</label>
                <br>
                <div class="col-sm-12">
