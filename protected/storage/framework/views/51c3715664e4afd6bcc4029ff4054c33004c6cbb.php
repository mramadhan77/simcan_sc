          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
                ...
                <div class="form-group">
                        <label for="cb_eselon_2" class="col-sm-3 control-label" align='left'>Uraian Jabatan Eselon </label>
                        <div class="col-sm-8">
                            <select class="form-control cb_eselon_2" name="cb_eselon_2" id="cb_eselon_2"></select>
                        </div>
                      </div>        
                <div class="form-group">
