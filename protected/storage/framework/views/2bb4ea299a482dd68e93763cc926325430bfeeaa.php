...
height: 100%; margin: 0; background-repeat: no-repeat; background-attachment: fixed;">
    ...
    <nav class="navbar navbar-findcond navbar-fixed-top" role="navigation">
      <div class="navbar-header">
        <a class="navbar-brand navbar-right" href="<?php echo e(url('/')); ?>">
          <div class="row">
            <img style="margin-top: -5px; margin-left: 10px; max-height: 40px; max-width: 30px;" src="<?php echo e(asset('vendor/default.png')); ?>"> simd@<strong>Perencanaan </strong> 
            <span class="badge" style="background-color: #006AC7; color:#fff;"> <?php echo e(Session::get('versiApp')); ?> </span>
          </div>        
        </a>
      </div>
      <ul class="nav navbar-top-links pull-right">
        <?php if(Auth::guest()): ?>
          <li><a href="<?php echo e(route('login')); ?>" role="button" ><i class="fa fa-sign-in fa-fw fa-lg"></i> Login<span class="sr-only">(current)</span></a></li>
        <?php else: ?>
          <li>
            <a href="<?php echo e(url('/home')); ?>" role="button"><i class="fa fa-user fa-fw fa-lg"></i> <?php echo e(Auth::user()->name); ?></a>
          </li>
        <?php endif; ?>
      </ul>
    </nav>
    ...
    <div class="container-fluid">
      ...
      <div class="col-sm-3 col-sm-push-9">
        <div class="col-md-12">
          <?php $__currentLoopData = $trxVisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataVisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
          <div class="panel panel-info">
            <div class="panel-heading">
              <h3 class="panel-title"><?php echo e($rPemda); ?></h3>
            </div>
            <div class="panel-body">
              <div class="box" >
                      <div id="iPemda">
                          <img id="profile-img" class="box-icon" src="<?php echo e(asset('vendor/default.png')); ?>" />
                      </div>
                      <div class="">                        
                          <h4 class="text-center">PEMERINTAH <?php echo e($rPemda); ?></h4>
                          <h4 class="text-center">Periode : <?php echo e($dataVisi->tahun_1); ?> s/d <?php echo e($dataVisi->tahun_5); ?></h4>
                      </div>
                  </div>
            </div>
          </div>
      ...
      <div class="col-sm-9 col-sm-pull-3">
            <div class="col-sm-12">
              ...
              <div class="panel-body">
                <?php $__currentLoopData = $trxVisi; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $dataVisi): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                  <p><strong>Visi :</strong> <?php echo e($dataVisi->uraian_visi_rpjmd); ?></p>
                <table id="tblRincianRpjmd" class="table-responsive" border="0">
                  ...
                  <tbody>
                    <?php $__currentLoopData = $trxRpjmd; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $data): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <tr>
                          <td width="5%" style="text-align: center"><?php echo e($data->no_misi); ?></td>
                          <td style="text-align: left"><?php echo e($data->uraian_misi_rpjmd); ?></td>
                      </tr>
                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                  </tbody>
                </table>                
...
var url_1 = "<?php echo e(url('/rpjmd/misi5tahun')); ?>";
var url_2 = "<?php echo e(url('/rpjmd/urusan5tahun')); ?>";
