      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h2 class="panel-title"><?php echo e($this->title); ?></h2>
          </div>  
...
<script id="details-inSasaran" type="text/x-handlebars-template">
  ...
  <?php echo $__env->make('kin.cascading.FrmRenstraProgram', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.cascading.FrmRenstraProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.cascading.FrmRenstraKegiatan', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.cascading.FrmRenstraKegiatanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.cascading.FrmCariItemRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
<script type="text/javascript" language="javascript" class="init" src="<?php echo e(asset('/protected/resources/views/kin/cascading/js_cascading.js')); ?>"></script>
<?php $__env->stopSection(); ?>
