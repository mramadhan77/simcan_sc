...
<html lang="en">
    ...
    <body>
        ...
        <div class="wrapper fadeInDown">
            <div id="formContent">
              <img class="profile-img-card" src="<?php echo e(asset('vendor/default.png')); ?>"  style="padding:20px;"/>
              <h1 class="active"> 
              ...
              <form method="POST" action="<?php echo e(route('login')); ?>">
                ...
                <select id="id_tahun" class="fadeIn fourth" name="id_tahun" placeholder="Tahun Anggaran/Perencanaan">
                  <?php $__currentLoopData = $tahun; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tahuns): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>   
                    <option value="<?php echo e($tahuns->tahun_rencana); ?>"><?php echo e($tahuns->tahun_rencana); ?></option>
                  <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                </select>
                <input type="submit" class="fadeIn fifth" value="Log In">
              </form>              
              <div id="formFooter">                
                by <img class="profile-img-card" src="<?php echo e(asset('vendor/bpkp_logo.png')); ?>" style="width:15%;" /> 
                @2018
              </div>
