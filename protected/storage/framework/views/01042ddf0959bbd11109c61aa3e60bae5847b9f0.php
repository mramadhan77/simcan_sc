  <div id="ModalIndikatorTujuan" class="modal fade" role="dialog">
        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" >
                ...
                <input type="hidden" class="form-control" id="id_indikator_tujuan_renstra_edit" name="id_indikator_tujuan_renstra_edit" readonly >
                <input type="hidden" class="form-control" id="thn_id_indikator_tujuan_edit" name="thn_id_indikator_tujuan_edit" readonly>
                <input type="hidden" class="form-control" id="id_tujuan_renstra_indikator_edit" name="id_tujuan_renstra_indikator_edit" readonly>
                ...
                <div class="form-group">
                    <label class="control-label col-sm-3" for="title">Uraian Indikator Tujuan Renstra :</label>
                    <div class="col-sm-8">
                      <textarea type="name" class="form-control" id="ur_indikator_tujuan_renstra" rows="3" disabled></textarea>
                    </div>
                    <input type="hidden" id="kd_indikator_tujuan_renstra" name="kd_indikator_tujuan_renstra">
                ...
                <label class="col-sm-12" style="text-align: left;">Rincian Target Indikator Tujuan Renstra :</label>
                <br>
    ...
    <div id="HapusTujuanIndikator" class="modal fade" role="dialog" data-backdrop="static">
                ...
                <div class="modal-body">
                  ...
                  <div class="alert alert-danger deleteContent">
                      <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border"  style="color:red;" aria-hidden="true"></i>
                        <br>
                        Yakin akan menghapus Indikator Tujuan Renstra : <strong><span id="nm_tujuan_indikator_hapus"></span></strong> ?
                        <br>
                        <br>
                  </div>
                </div>
