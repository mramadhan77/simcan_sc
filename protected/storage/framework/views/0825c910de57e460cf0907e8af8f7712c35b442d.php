...
<?php $__env->startSection('content'); ?>
    ...
    <div class="modal-dialog modal-lg"  >
      ...
      <!-- <form class="form-horizontal" role="form"> -->
        <div class="modal-body">
          <form class="form-horizontal" role="form" autocomplete='off' action="<?php echo e(route('TambahPerkada')); ?>" method="post" >
  ...
  <div id="TambahZonaPerkada" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-lg"  >
      ...
      <!-- <form class="form-horizontal" role="form"> -->
        <div class="modal-body">
          <form class="form-horizontal" role="form" autocomplete='off' action="<?php echo e(route('TambahZonaPerkada')); ?>" method="post" >
              <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-8">
      					 	<select class="form-control" name="id_zona_ssh" id="id_zona_ssh">
      					 		<?php $__currentLoopData = $refzona; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $val): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                      <option value=<?php echo e($val->id_zona); ?>><?php echo e($val->keterangan_zona); ?></option>
  ...
  <div id="ModalTarifPerkada" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-lg"  >
      ...
      <!-- <form class="form-horizontal" role="form"> -->
        <div class="modal-body">
          <form class="form-horizontal" role="form" autocomplete='off' action="<?php echo e(route('TambahTarifPerkada')); ?>" method="post" onsubmit="return false;">
              <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
  ...
  <div id="CopyDataTarif" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      ...
      <div class="modal-body">
          <form name="frmModalCopy" class="form-horizontal" role="form" autocomplete='off' action="<?php echo e(url('/asb/prosesASB')); ?>" method="" >
              <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
              <div class="form-group">
                <div class="col-sm-12">
...
<script type="text/javascript" language="javascript" class="init" src="<?php echo e(asset('/protected/resources/views/ssh/perkada/js_perkada.js')); ?>"></script>
<?php $__env->stopSection(); ?>
