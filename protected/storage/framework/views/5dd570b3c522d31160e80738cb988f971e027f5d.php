        ...
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" >
                ...
                <input type="hidden" class="form-control" id="id_indikator_sasaran_rpjmd_edit" name="id_indikator_sasaran_rpjmd_edit" readonly >
                <input type="hidden" class="form-control" id="thn_id_indikator_sasaran_edit" name="thn_id_indikator_sasaran_edit" readonly>
                <input type="hidden" class="form-control" id="id_sasaran_rpjmd_indikator_edit" name="id_sasaran_rpjmd_indikator_edit" readonly>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" id="kd_indikator_sasaran_rpjmd" name="kd_indikator_sasaran_rpjmd">
                ...
                <label class="col-sm-12" style="text-align: left;">Rincian Target Indikator Sasaran RPJMD :</label>
                <br>
                ...
                <div class="modal-body">
                  ...
                  <div class="alert alert-danger deleteContent">
                      <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border"  style="color:red;" aria-hidden="true"></i>
                        <br>
                        Yakin akan menghapus Indikator Sasaran RPJMD : <strong><span id="nm_sasaran_indikator_hapus"></span></strong> ?
                        <br>
                        <br>
                  </div>
                </div>
