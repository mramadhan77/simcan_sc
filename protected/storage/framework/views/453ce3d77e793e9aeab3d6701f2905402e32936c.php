...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = ' Nilai dan Kontribusi Sektor dalam PDRB berdasarkan Harga Konstan ';
    ...
    <div role="tabpanel" class="tab-pane fade in active" id="pdrb">
                  <div class="col-md-12">
                  <div class="add">
                      <button id="btnAddPdrb" type="button" class="btn btn-labeled btn-sm btn-success"><span class="btn-label"><i class="glyphicon glyphicon-plus"></i></span>Tambah PDRB</button>
                      <button id="btnPrintPdrb" type="button" class="btn btn-labeled btn-sm btn-primary"><span class="btn-label"><i class="glyphicon glyphicon-print"></i></span>Print PDRB</button>
                  </div>
                  <div class="">
                  <table id="tblPdrb" class="table table-striped table-bordered table-responsive compact" width="100%" cellspacing="0">
                        <thead>
                            <tr>
 ...
 <div id="ModalPdrb" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmModalPdrb" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
<!--             <input type="hidden" name="id_pemda" id="id_pemda"> -->
<!--             <input type="hidden" name="id_Pdrb" id="id_Pdrb"> -->
            <div class="row">
            <div class="col-sm-2" style="text-align: center;">
              <i class="fa fa-desktop fa-fw" style="font-size: 100px;color: #357EBD;"></i>
            </div>
            <div class="col-sm-10">
...
<!--                    <input type="text" class="form-control number" id="text_kecamatan" name="text_kecamatan" required="required" align='right'> -->
            ...
            <div class="form-group">
              ...
              <label for="nmin1persen" class="col-sm-2" align='left'>Persentase N-1</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <label for="nmin2persen" class="col-sm-2" align='left'>Persentase N-2</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <label for="nmin3persen" class="col-sm-2" align='left'>Persentase N-3</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <label for="nmin4persen" class="col-sm-2" align='left'>Persentase N-4</label>
              <div class="col-sm-4">
            ...
            <div class="form-group">
              ...
              <label for="nmin5persen" class="col-sm-2" align='left'>Persentase N-5</label>
              <div class="col-sm-4">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" class="btn btn-sm btn-success btnPdrb btn-labeled" data-dismiss="modal">
...
<div id="ModalHapusPdrb" class="modal fade" role="dialog" data-backdrop="static">
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title"></h4>
      ...
      <div class="modal-body">
        <form name="frmModalHapusPdrb" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
<!--             <input type="hidden" name="id_pemda" id="id_pemda"> -->
<!--             <input type="hidden" name="id_Pdrb" id="id_Pdrb"> -->
            <div class="row">
        ...
        <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" class="btn btn-sm btn-success btnHapusPdrb btn-labeled" data-dismiss="modal">
...
$(document).ready(function() {
	//alert('A');
var pdrb_tbl=$('#tblPdrb').DataTable({
                  processing: true,
                  serverSide: true,
                  dom : 'BfRtip',                  
                  autoWidth : false,
                  "ajax": {"url": "./pdrb/getListpdrb"},
                  "language": {
                      "decimal": ",",
                      "thousands": "."},
                  "columns": [
...
$(document).on('click', '#btnAddPdrb', function() {
	  $('.btnPdrb').removeClass('edit');
	  $('.btnPdrb').addClass('add');
	  $('.modal-title').text('Tambah Kontribusi PDRB berdasarkan Harga Konstan');
	  $('.form-horizontal').show();
	  $('#ModalPdrb').modal('show');
	  $('#nama_kolom').val("");
	  $('#kecamatan').val("");
	  $('#nmin1').val("");
	  $('#nmin2').val("");
...
$( ".kecamatan" ).change(function() {
    ...
    $.ajax({
        ...
        type: "GET",
        url: './pdrb/getSektorpdrb/'+$('#tahun').val()+'/'+$('#kecamatan').val(),
        dataType: "json",
...
//edit function
$(document).on('click', '#btnEditpdrb', function() {
//alert("1");

var data = pdrb_tbl.row( $(this).parents('tr') ).data();

  $('.btnPdrb').removeClass('add');
  $('.btnPdrb').addClass('edit');
  $('.modal-title').text('Edit Kontribusi PDRB berdasarkan Harga Konstan');
  $('.form-horizontal').show();
  $('#ModalPdrb').modal('show');
...
$(document).on('click', '#btnHapuspdrb', function() {
	var data = pdrb_tbl.row( $(this).parents('tr') ).data();
	$('.btnHapusPdrb').removeClass('add');
	  $('.btnHapusPdrb').addClass('remove');
	  $('.modal-title').text('Hapus Kontribusi PDRB berdasarkan Harga Konstan');
	  $('.form-horizontal').show();
	 $('#ModalHapusPdrb').modal('show');
...
$(document).on('click', '#btnPrintPdrb', function() {

	//alert("print");
     window.open('./PrintPdrb/2018');
