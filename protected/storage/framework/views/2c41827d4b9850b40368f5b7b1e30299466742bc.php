            ...
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="tahun_rkpd" class="col-sm-3 control-label text-left" align='left'>Tahun Perencanaan :</label>
                        <div class="col-sm-2">                            
                            <input class="form-control text-center" type="text" id="tahun_rkpd" name="tahun_rkpd" value="<?php echo e(Session::get('tahun')); ?>" style="text-align: center; vertical-align:middle" disabled>
                        </div>
                        <div class="btn-group">
