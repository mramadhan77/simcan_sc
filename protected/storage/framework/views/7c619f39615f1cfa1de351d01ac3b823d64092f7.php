        ...
        <div class="container text-center">
                <div class="row">
                    <div class="col-sm-4 col-md-4 col-lg-4">               
                        <img class="" src="<?php echo e(asset('img/panrb.png')); ?>" style="width:30%; margin-top: -20px;filter: drop-shadow(0px 16px 10px rgba(158, 158, 158));" /></div>
                    <div class="col-sm-4 col-md-4 col-lg-4">
                    ...
                    <div class="col-sm-4 col-md-4 col-lg-4">               
                        <img class="" src="<?php echo e(asset('vendor/bpkp_logo.png')); ?>" style="width:50%; margin-top: 20px;filter: drop-shadow(0px 16px 10px rgba(158, 158, 158));" />
                    </div>
                </div>
            </div>
            <hr>
                        ...
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img src="<?php echo e('assets/images/branding.png'); ?>"></p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img src="<?php echo e('assets/images/growth.png'); ?>"></p>
                ...
                <div class="image-flip" ontouchstart="this.classList.toggle('hover');">
                    <div class="mainflip">
                        <div class="frontside">
                            <div class="card">
                                <div class="card-body text-center">
                                    <p><img src="<?php echo e('assets/images/debt.png'); ?>"></p>
