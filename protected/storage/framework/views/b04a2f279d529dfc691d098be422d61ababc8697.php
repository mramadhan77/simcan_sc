    ...
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0; background: #0E203A; border-color: #ccc; color:#fff;">
                <div class="navbar-header">
                    ...
                    <span style="color:#fff"> simd@<strong>Perencanaan</strong> </span><span class="badge" style="background-color: #f89406;"> <?php echo e(Session::get('versiApp')); ?> </span>
                    </a>
                </div>
