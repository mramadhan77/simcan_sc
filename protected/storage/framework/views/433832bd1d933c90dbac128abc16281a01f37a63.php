...
<body style="background-image: linear-gradient(to bottom, rgb(96,108,136) 0%,rgb(63,76,107) 100%);
    ...
    <nav class="navbar navbar-findcond navbar-fixed-top" role="navigation">
            <div class="navbar-header">
                <a class="navbar-brand navbar-right" href="<?php echo e(url('/home')); ?>">
                    <div class="row">
                        <img style="margin-top: -5px; margin-left: 10px; max-height: 40px; max-width: 30px;" src="<?php echo e(asset('vendor/default.png')); ?>"> simd@<strong>Integrated</strong> 
                        :: <?php echo e(Session::get('xPemda')); ?>

                        <?php if( Session::get('AppType') === 0 ): ?>
                        <span class="badge" style="background-color: #3a87ad; color:#fff;"> <?php echo e(Session::get('versiApp')); ?> - Provinsi </span>
                        <?php else: ?>
                            <span class="badge" style="background-color: #f89406; color:#fff;"> <?php echo e(Session::get('versiApp')); ?> </span>
                        <?php endif; ?> 
                    </div>
                </a>                
            </div>
            <ul class="nav navbar-top-links pull-right">
                ...
                <?php else: ?> 
                    ...
                    <li class="dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false">
                            <i class="fa fa-user fa-fw"></i> <?php echo e(Auth::user()->name); ?> <span class="fa fa-caret-down fa-fw fa-lg"></span>
                        </a>
                            <ul class="dropdown-menu dropdown-user" role="menu">
                                <li>
    ...
    <div class="row">
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="our-services-wrapper mb-60">
                <a href="<?php echo e(url('/asb/dash')); ?>" style="text-decoration:none;">
                <div class="services-inner"  style="background:#eee">
                    <div class="our-services-img">
                        <img src="<?php echo e('./assets/images/marketing_1.png'); ?>" width="68px" alt="">
                    </div>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="our-services-wrapper mb-60">
                <a href="<?php echo e(url('/rpjmd/dash')); ?>" style="text-decoration:none;">
                    <div class="services-inner"  style="background:#eee">
                        <div class="our-services-img">
                            <img src="<?php echo e('./assets/images/marketing.png'); ?>" width="68px" alt="">
                        </div>
                        <div class="our-services-text">
                            <h4>RPJMD & Renstra</h4>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="our-services-wrapper mb-60">
                <a href="<?php echo e(url('/rkpd/dash')); ?>" style="text-decoration:none;">
                    <div class="services-inner"  style="background:#eee">
                        <div class="our-services-img">
                            <img src="<?php echo e('./assets/images/marketing-strategy.png'); ?>" width="68px" alt="">
                        </div>
                        <div class="our-services-text">
                            <h4>RKPD & Renja</h4>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="our-services-wrapper mb-60">
                <a href="<?php echo e(url('/modul3')); ?>" style="text-decoration:none;">
                    <div class="services-inner"  style="background:#eee;">
                        <div class="our-services-img">
                            <img src="<?php echo e('./assets/images/seo.png'); ?>" width="68px" alt="">
                        </div>
                        <div class="our-services-text">
                            <h4>Anggaran</h4>
        ...
        <div class="col-xl-6 col-lg-6 col-md-6 col-sm-6">
            <div class="our-services-wrapper mb-60">
                <a href="<?php echo e(url('/kin')); ?>" style="text-decoration:none;">
                    <div class="services-inner"  style="background:#eee">
                        <div class="our-services-img">
                            <img src="<?php echo e('./assets/images/sakip.png'); ?>" width="68px" alt="">
                        </div>
                        <div class="our-services-text">
                            <h4>S A K I P</h4>
            ...
            <b><a href="http://www.bpkp.go.id" title="Badan Pengawasan Keuangan dan Pembangunan" style="color:#fff">Badan Pengawasan Keuangan dan Pembangunan</a></b>
                ...
                <li class="navbar-btn btn pull-right dropdown" style="color:#fff">
                    ...
                    <ul class="dropdown-menu" role="menu" style="color:#fff">
                        <li><a href="<?php echo e(url('/')); ?>"><i class="fa fa-cubes fa-fw text-info"></i> Dashboard</a></li>
                        <li class="divider"></li>
                        <li><?php if($akses->get(110)): ?> <a href="<?php echo e(url('/admin/parameter/user')); ?>"><i class="fa fa-user fa-fw text-info"></i> User Management</a> <?php endif; ?></li>
                        <li><?php if($akses->getMulti([101, 102, 103, 104, 105, 106, 107, 108, 109])): ?> <a href="<?php echo e(url('/parameter/dash')); ?>"><i class="fa fa-cogs fa-fw text-info"></i> Parameter</a> <?php endif; ?></li>
                        <li><?php if($akses->get(9)): ?> <a href="<?php echo e(url('/admin/update')); ?>"><i class="fa fa-refresh fa-fw text-info"></i> Cek Update</a> <?php endif; ?></li>
                    </ul>
                </li>
        </div>
  ...
  <div class="modal-dialog modal-lg"  >
    <div class="modal-content">
      <div class="modal-header">
        ...
        <form name="frmModalUser" class="form-horizontal" role="form" autocomplete='off' action="<?php echo e(Request::url()); ?>" method="post">
          <div class="row">
          ...
          <div class="col-sm-10">
            ...
            <div id="divPassword" class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-4">
                      <div class="input-group">
                        <input id="password_confirmation" type="password" class="form-control<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>" name="password_confirmation" required data-toggle="popover" data-html="true" data-container="body" title="User dan Group User" data-trigger="hover" data-content="Masukkan Kembali Password Baru, harus sama dengan sebelumnya sebagai konfirmasi">
