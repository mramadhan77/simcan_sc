...
$( ".cb_pegawai" ).change(function() {
  ...
  <?php echo $__env->make('kin.perkin.es2.JsPerkinDokumen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.perkin.es2.JsPerkinSasaranIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>  
  <?php echo $__env->make('kin.perkin.es2.JsPerkinProgram', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
