            ...
            <div id="divPassword" class="form-group<?php echo e($errors->has('password') ? ' has-error' : ''); ?>">
                    ...
                    <div class="col-md-4">
                      <div class="input-group">
                        <input id="password_confirmation" type="password" class="form-control<?php echo e($errors->has('password_confirmation') ? ' has-error' : ''); ?>" name="password_confirmation" required>
...
var dataApp = "<?php echo e(Session::get('AppType')); ?>";
...
var user_tbl = $('#users-table').DataTable({
    ...
    // dom : 'bfrtIp',
    autoWidth : false,
    ajax: '<?php echo e(url('/admin/parameter/user/')); ?>',
    columns: [
