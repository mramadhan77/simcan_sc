...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = 'Data Program Renja OPD - Pergeseran';
        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <p><h2 id="judul" class="panel-title"> Data Program Renja Perangkat Daerah - Pergeseran</h2></p>
                </div>
...
<script id="details-inKeg" type="text/x-handlebars-template">
  ...
  <?php echo $__env->make('apbd.program_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.program_indikator_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.kegiatan_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.kegiatan_indikator_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.pelaksana_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.aktivitas_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.lokasi_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.belanja_pd', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

  <?php echo $__env->make('apbd.cariProgramRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariKegiatanRenstra', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariProgramRef', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariKegiatanRef', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariSubUnit', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariAktivitasASB', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariLokasiModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariLokasiTeknisModal', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariItemSSH', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.cariRekening', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.ModalCopyBelanja', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('apbd.loadBelanjaASB', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>

<?php $__env->stopSection(); ?>

<?php $__env->startSection('scripts'); ?>
  <script src="<?php echo e(asset('/protected/resources/views/apbd1/js/js_penyesuaian_pd.js')); ?>"></script>
<?php $__env->stopSection(); ?>
