...
<div class="container-fluid col-sm-12 col-md-12 col-lg-12">	
    ...
    <?php if(Session::has('pesan')): ?> 
        <div class="alert alert-info"><button type="button" class="close" data-dismiss="alert" aria-hidden="true"><i class="fa fa-times-circle-o fa-fw fa-lg text-danger"></i></button>
            <h4><?php echo e(Session::get('pesan')); ?></h4>
        </div>
    <?php endif; ?>
    </div>   
    <div id="pesan"></div>
    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
                            ...
                            <form action="<?php echo e(url('admin/update/updateDB')); ?>" method="post" enctype="multipart/form-data">
                                       ...
                                       <tr>
                                            <td style="text-align: left; vertical-align:middle">
                                                <div><label for="dbVersion"  align='left' >Database Engine : </label>
                                                    <label for="dbVersion"  align='left' style="color: #b94743"><?php echo e($dataVersion); ?></label></div>
                                                <div><label for="dbNama"  align='left' >Nama Database : </label>
                                                    <label for="dbNama"  align='left' style="color: #b94743"><?php echo e($namaDB); ?></label></div>
...
<?php $__env->startSection('scripts'); ?>
  <script type="text/javascript" language="javascript" class="init" src="<?php echo e(asset('/protected/resources/views/update/js_update.js')); ?>"></script>
<?php $__env->stopSection(); ?>
