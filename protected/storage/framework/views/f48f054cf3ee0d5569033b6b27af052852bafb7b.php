...
?>
<?php $__env->startSection('layoutBody'); ?>
<div id="wrapper">
            ...
            <div class="navbar-header">
                <a class="navbar-brand navbar-right" href="<?php echo e(url('/home')); ?>" style="margin-top: -5px; margin-left: 10px; max-height: 40px;">
                 <span class="fa-stack">
                    ...
                    </span><span style="color:#fff"> simd@<strong>Perencanaan</strong> ver <strong>1.0 </strong><i><sub><?php echo e(Session::get('versiApp')); ?></sub></i></strong>
                    </span>
                    </a>
            </div>
                ...
                <?php else: ?>
                    ...
                    <li class="dropdown" style="color:#fff">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" role="button" aria-expanded="false" style="color:#fff">
                            <i class="fa fa-user fa-fw"></i> <?php echo e(Auth::user()->name); ?> <span class="caret"></span>
                        </a>
...
<?php echo $__env->make('layouts.baselineLayout', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>