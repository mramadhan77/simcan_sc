                ...
                <div class="row">
                    <div class="col-lg-10 text-left">
                        <?php $__currentLoopData = $unit; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $units): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <h3 class="panel-title">Pohon Kinerja Sasaran Renstra : <b> <?php echo e($units->nm_unit); ?>  </b> </h3> 
                    ...
                    <?php $__currentLoopData = $misi->TrxRenstraTujuans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tujuan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        'children': [
                            <?php $__currentLoopData = $tujuan->TrxRenstraSasarans; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $sasaran): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                {'name': 'Sasaran Strategis','title': '<?php echo e($sasaran->uraian_sasaran_renstra); ?>','className': 'level4',
                                'children': [
                                    <?php $__currentLoopData = $sasaran->KinTrxCascadingProgramOpds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $program): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                        {'name': 'Sasaran Program','title': '<?php echo e($program->uraian_hasil_program); ?>','className': 'level5',
                                        'children': [
                                            <?php $__currentLoopData = $program->KinTrxCascadingKegiatanOpds; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $kegiatan): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                                {'name': 'Sasaran Kegiatan','title': '<?php echo e($kegiatan->uraian_hasil_kegiatan); ?>',},
                                            <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                                        ]
                                    },
                                    <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
