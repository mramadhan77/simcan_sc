...
@include('kin.perkin.es3.FrmPerkinDokumen')
@include('kin.perkin.es3.FrmPerkinProgramIndikator')
@include('kin.perkin.es3.FrmPerkinKegiatan')
@endsection

@section('scripts')
<script type="text/javascript" language="javascript" class="init" src="{{ asset('/protected/resources/views/kin/perkin/es3/js_perkin_es3.js')}}"> </script>
@endsection
