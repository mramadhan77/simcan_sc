                        ...
                        <tbody>
                          <tr>
                              <td width="20%" style="text-align: center; vertical-align:middle" >
                                <input type="text" class="form-control number" id="indisasaran1_edit" name="indisasaran1_edit" style="text-align: right; " readonly>
                              </td>
                              <td width="20%" style="text-align: center; vertical-align:middle" >
                                <input type="text" class="form-control number" id="indisasaran2_edit" name="indisasaran2_edit" style="text-align: right; " readonly>
                              </td>
                              <td width="20%" style="text-align: center; vertical-align:middle" >
                                <input type="text" class="form-control number" id="indisasaran3_edit" name="indisasaran3_edit" style="text-align: right; " readonly>
                              </td>
                              <td width="20%" style="text-align: center; vertical-align:middle" >
                                <input type="text" class="form-control number" id="indisasaran4_edit" name="indisasaran4_edit" style="text-align: right; " readonly>
                              </td>
                              <td width="20%" style="text-align: center; vertical-align:middle" >
                                <input type="text" class="form-control number" id="indisasaran5_edit" name="indisasaran5_edit" style="text-align: right; " readonly>
                              </td>
                          </tr>
                          <tr style="background: #428bca; color: #fff">
                              <td style="text-align: center; vertical-align:middle; font-weight: bold;">Kondisi Awal :</td>
                              <td style="text-align: center; vertical-align:middle" >
                                <input type="text" class="form-control number" id="indisasaran_awal_edit" name="indisasaran_awal_edit" style="text-align: right; " readonly>
                              </td>
                              <td colspan="2" style="text-align: center; vertical-align:middle; font-weight: bold;">Kondisi Akhir :
                              </td>
                              <td style="text-align: center; vertical-align:middle" >
                                 <input type="text" class="form-control number" id="indisasaran_akhir_edit" name="indisasaran_akhir_edit" style="text-align: right; " readonly>
                              </td>
                          </tr>
                        </tbody>
                  </table>
                  ...
                  <div class="row">
                      ...
                      <div class="col-sm-10 text-right">
                        <div class="ui-group-buttons">
                          <button type="button" class="btn btn-success btnSimpanSasaranIndikator btn-labeled hidden" data-dismiss="modal">
