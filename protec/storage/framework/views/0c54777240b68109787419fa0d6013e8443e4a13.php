        ...
        <div class="modal-body">
          <form name="frmModalLokasi" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
            ...
            <div class="form-group">
              ...
              <div class="col-sm-3 chkLokasi hidden">
            ...
            <div class="form-group hidden">
                    ...
                    <div class="col-sm-5">
                        <select type="text" class="form-control" id="sumber_data_lokasi" name="sumber_data_lokasi">
                          <option value="0">Forum Perangkat Daerah</option>
                          <option value="1">Rancangan RKPD</option>
                        </select>
                </div>
            </div>
            <div class="form-group">
                    ...
                    <table class="table table-bordered table-condensed">
                        <thead style="background-color: #428bca; color: #fff">
                          ...
                          <tr>
                            ...
                            <td width="30%" style="text-align: center; vertical-align:middle;">Rancangan</td>
                          </tr>
                        </thead>
