          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
                ...
                <input type="hidden" class="form-control" name="id_perkin_dok" id="id_perkin_dok"> 
                <div class="form-group">
                    <label for="tahun_dok" class="col-sm-3 control-label" align='left'>Tahun Dokumen </label>
                    <div class="col-sm-2">
                        <input type="text" class="form-control number" id="tahun_dok" name="tahun_dok" required="required" maxlength="4">
                    </div>
                </div>
                <div class="form-group">
                    <label for="no_perkin_dok" class="col-sm-3 control-label" align='left'>Nomor Dokumen </label>
                    <div class="col-sm-8">
                        <input type="text" class="form-control" id="no_perkin_dok" name="no_perkin_dok" required="required">
                    </div>
                </div>
                ...
                <div class="form-group has-feedback">
                    <label for="tgl_perkin_tmt" class="col-sm-3 control-label" align='left'>Dokumen berlaku mulai </label>
                    <input type="hidden" name="tgl_perkin_tmt" id="tgl_perkin_tmt">
                    <div class="col-sm-4">
                        <input type="text" class="form-control datepicker" id="tgl_perkin_tmt_x" name="tgl_perkin_tmt_x" style="text-align: center;">
                        <i class="fa fa-calendar fa-fw fa-lg text-primary form-control-feedback"></i>              
                    </div>
                </div>
                <div class="form-group">
                        <label for="cb_eselon_3a" class="col-sm-3 control-label" align='left'>Uraian Jabatan Eselon </label>
                        <div class="col-sm-8">
                            <select class="form-control cb_eselon_3a hidden" name="cb_eselon_3a" id="cb_eselon_3a" disabled></select>
