  ...
  <div class="modal-dialog modal-lg" role="document" >
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form name="frmModalIndikator" class="form-horizontal" role="form" autocomplete='off' method="post" enctype="multipart/form-data">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="submit" class="btn btn-sm btn-success btnIndikator btn-labeled" data-dismiss="modal">
...
<?php $__env->startSection('scripts'); ?>
  <script type="text/javascript" language="javascript" class="init" src="<?php echo e(asset('/protected/resources/views/parameter/js/js_indikator.js')); ?>"></script>
<?php $__env->stopSection(); ?>
