...
<div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = 'Daftar Usulan Musrenbang RKPD di Kecamatan';
        ...
        <div class="col-md-12">
            <div class="panel panel-info">
                <div class="panel-heading">
                    <p><h2 id="judul" class="panel-title"> <?php echo e($this->title); ?></h2></p>
                </div>
                <div class="panel-body">
                  <form name="" class="form-horizontal" role="form" autocomplete='off' action="" method="post">
                    ...
                    <div class="divAddMusrenCam col-sm-offset-2">
                      <button id="btnAddMusrenCam" type="button" class="btn btn-labeled btn-success"><span class="btn-label"><i class="fa fa-plus fa-lg fa-fw"></i></span>Tambah Usulan Kecamatan</button>
                    </div>
                  </form>                   
...
<div id="ModalMusrenCam" class="modal fade" role="dialog" data-backdrop="static">
        <div class="modal-dialog modal-lg">
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form name="frmModalMusrenCam" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="hidden" id="id_musrencam_form" name="id_musrencam_form">
                <input type="hidden" id="tahun_musren" name="tahun_musren">
                <input type="hidden" id="id_kecamatan_form" name="id_kecamatan_form">
                <div class="form-group">
                ...
                <div class="col-sm-12">
                    <table class="table table-striped table-bordered table-responsive compact">
                        ...
                        <tbody>
                          ...
                          <tr>
                              <td width="10%" style="text-align: center; vertical-align:middle;">
                                <label class="control-label" align='left'>Kecamatan :</label>
                              </td>
                              <td width="15%" style="text-align: center; vertical-align:middle;">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" id="btnMusrenCam" class="btn btn-success btn-labeled" data-dismiss="modal">
...
<div id="HapusMusrenCam" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <input type="hidden" id="id_musrencam_hapus" name="id_musrencam_hapus">
            <div class="alert alert-danger deleteContent">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border"  style="color:red;" aria-hidden="true"></i>
                Yakin akan menghapus Data Usulan ini : <strong><span id="ur_musrencam_hapus"></span></strong> ?
                <br>
                <br>
          ...
          <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" id="btnDelMusrenCam" class="btn btn-sm btn-danger btn-labeled" data-dismiss="modal">
          ...
          <div class="modal-content">
            ...
            <div class="modal-body">
              <form name="frmModalLokasiMusrendes" class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
                <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">
                <input type="hidden" id="id_musrencam_lokasi" name="id_musrencam_lokasi">
                ...
                <input type="hidden" id="id_lokasi_musrencam" name="id_lokasi_musrencam">
                <div class="form-group">
                  <label class="control-label col-sm-3" for="id">No Urut :</label>
                  <div class="col-sm-2">
                ...
                <div class="form-group">
                      <label class="control-label col-sm-3" for="title">Kecamatan / Desa :</label>
                        <div class="col-sm-4">
                ...
                <div class="form-group">
                  <label class="control-label col-sm-3" for="rtrw">Volume Desa :</label>
                  <div class="col-sm-2">
                        <input type="text" class="form-control number" style="text-align: right;" id="volume_rw_lokasi" name="volume_rw_lokasi" disabled>
                  </div>
                  <label class="control-label col-sm-2" for="rtrw">Volume Kecamatan :</label>
                  <div class="col-sm-2" data-toggle="popover" data-html="true" data-container="body" title="Musrenbang RKPD di Kecamatan" data-trigger="hover" data-content="Volume diisi dengan volume yang disetujui<br>Untuk usulan yang ditolak diisi dengan 0">
...
<div id="HapusLokasiMusrencam" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
            <h4 style="text-align: center;">Hapus Data Usulan Musrenbang Desa/Kelurahan</h4>
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-danger deleteContent">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border"  style="color:red;" aria-hidden="true"></i>
                Yakin akan menghapus Data Lokasi Usulan untk Desa/Kelurahan : <strong><span id="nama_desa_hapus"></span></strong> ?
                <br>
                <br>
                <strong>Catatan : Penghapusan data ini mempengaruhi data selanjutnya akan ikut terhapus.....!!!!</strong> 
          </div>
          ...
          <div class="modal-footer">
                <div class="row">
                    ...
                    <div class="col-sm-10 text-right">
                      <div class="ui-group-buttons">
                        <button type="button" id="btnDelLokasiMusrencam" class="btn btn-sm btn-danger btn-labeled" data-dismiss="modal">
                            <span class="btn-label"><i class="glyphicon glyphicon-trash"></i></span>Hapus</button>
                        <div class="or"></div>
                        <button type="button" class="btn btn-sm btn-warning btn-labeled" data-dismiss="modal" aria-hidden="true">
                            <span class="btn-label"><i class="glyphicon glyphicon-log-out"></i></span>Tutup</button>
...
<div id="StatusProgram" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
            <h4 style="text-align: center;">Perubahan Status Usulan Kecamatan</h4>
        </div>
        <div class="modal-body">
            <input type="hidden" id="id_musrencam_posting" name="id_musrencam_posting">
...
function LoadUsulKecamatan($id_kecamatan){
    usulan_tbl=$('#tblMusrendes').DataTable({
                  ...
                  dom : 'BfRtip',                  
                  autoWidth : false,
                  "ajax": {"url": "musrencam/getData/"+$id_kecamatan},
                  "language": {
                      "decimal": ",",
                      "thousands": "."},
                  "columns": [
...
$('#btnAddMusrenCam').click(function(){
  $('#btnMusrenCam').addClass('addMusrenCam');
  $('#btnMusrenCam').removeClass('editMusrenCam');      
  $('.form-horizontal').show();
  $('.modal-title').text('Tambah Daftar Usulan Musrenbang RKPD di Kecamatan');

  $('#id_musrencam_form').val(null);
  $('#tahun_musren').val(<?php echo e(Session::get('tahun')); ?>);
  $('#id_kecamatan_form').val($('#id_kecamatan').val());
  ...
  document.frmModalMusrenCam.status_pelaksanaan[0].checked=true;
  ...
  $('#ModalMusrenCam').modal('show');

});

$('.modal-footer').on('click', '.addMusrenCam', function() {
      $.ajaxSetup({
      ...
      $.ajax({
          type: 'post',
          url: 'musrencam/addMusrenCam',
          data: {
              '_token': $('input[name=_token]').val(),
              // 'id_musrencam' : $('#id_musrencam_form').val(),
              'tahun_musren' : $('#tahun_musren').val(),
              'no_urut' : $('#no_urut_usulan').val(),
              'id_renja' : $('#id_renja').val(),
              'id_kecamatan' : $('#id_kecamatan_form').val(),
...
$(document).on('click', '#btnEditUsulanKec', function() {

var data = usulan_tbl.row( $(this).parents('tr') ).data();

  $('#btnMusrenCam').removeClass('addMusrenCam');
  $('#btnMusrenCam').addClass('editMusrenCam');      
  $('.form-horizontal').show();
  $('.modal-title').text('Edit Daftar Usulan Musrenbang RKPD di Kecamatan');

  $('#id_musrencam_form').val(data.id_musrencam);
  $('#tahun_musren').val(data.tahun_musren);
  $('#id_kecamatan_form').val(data.id_kecamatan);
  ...
  $('#volume_rw').val(data.volume_desa);
  $('#ur_satuan_rw').val(data.uraian_satuan_desa);
  $('#id_satuan_rw').val(data.id_satuan_desa);
  $('#harga_satuan_rw').val(data.harga_satuan_desa);
  $('#jumlah_pagu_rw').val(data.jml_pagu_desa);
  ...
  document.frmModalMusrenCam.status_pelaksanaan[data.status_pelaksanaan].checked=true;
...
$('.modal-footer').on('click', '.editMusrenCam', function() {
      $.ajaxSetup({
         headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') }
      });
...
$(document).on('click', '#btnHapusMusrenCam', function() {

  var data = usulan_tbl.row( $(this).parents('tr') ).data();

  $('#id_musrencam_hapus').val(data.id_musrencam);
  $('#ur_musrencam_hapus').text(data.uraian_asb);  

  $('#HapusMusrenCam').modal('show');

});

$(document).on('click', '#btnDelMusrenCam', function() {
    $.ajaxSetup({
       headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') }
    });
    ...
    $.ajax({
      type: 'post',
      url: 'musrencam/hapusMusrenCam',
      data: {
        '_token': $('input[name=_token]').val(),
        'id_musrencam': $('#id_musrencam_hapus').val()
      },
      success: function(data) {
        usulan_tbl.ajax.reload();
        if(data.status_pesan==1){
...
$(document).on('click','#btnAddLokasiUsulan', function() {
  ...
  $('.form-horizontal').show();
  $('.modal-title').text('Tambah Lokasi Usulan Musrenbang RKPD di Kecamatan');

  $('#id_musrencam_lokasi').val(data.id_musrencam);
  $('#id_musrendes_lokasi').val(null);
...
$('.modal-footer').on('click', '.addLokasi', function() {
      ...
      $.ajax({
          type: 'post',
          url: 'musrencam/addMusrenCamLokasi',
          data: {
              '_token': $('input[name=_token]').val(),
              'tahun_musren' : $('#tahun_musren_lokasi').val(),
              'no_urut' : $('#no_urut_lokasi').val(),
              'id_musrencam' : $('#id_musrencam_lokasi').val(),
              'id_lokasi' : $('#id_desa_cb').val(),
              'id_desa' : $('#id_desa_cb').val(),
              'rt' : $('#id_rt_lokasi').val(),
              'rw' : $('#id_rw_lokasi').val(),
              'uraian_kondisi' : $('#uraian_lokasi').val(),
              'id_musrendes' : $('#id_musrendes_lokasi').val(),
              'volume' : $('#volume_desa_lokasi').val(),
              'volume_desa' : $('#volume_rw_lokasi').val(),  
          },
          success: function(data) {
              usulan_tbl.ajax.reload();
              if(data.status_pesan==1){
...
$(document).on('click','#btnEditLokasiMusren', function() {
  ...
  $('.form-horizontal').show();
  $('.modal-title').text('Ubah Lokasi Usulan Musrenbang RKPD di Kecamatan');
  ...
  $('#id_desa_cb').val(data.id_desa);
  $('#id_lokasi').val(data.id_desa);
  $('#id_lokasi_musrencam').val(data.id_lokasi_musrencam);
  $('#uraian_lokasi').val(data.uraian_kondisi);
  $('#volume_rw_lokasi').val(data.volume_desa);
  $('#volume_desa_lokasi').val(data.volume);
...
$('.modal-footer').on('click', '.editLokasi', function() {
      ...
      $.ajax({
          type: 'post',
          url: 'musrencam/editMusrenCamLokasi',
          data: {
              '_token': $('input[name=_token]').val(),
              'tahun_musren' : $('#tahun_musren_lokasi').val(),
              'no_urut' : $('#no_urut_lokasi').val(),
              'id_musrencam' : $('#id_musrencam_lokasi').val(),
              'id_lokasi_musrencam' : $('#id_lokasi_musrencam').val(),
              'id_lokasi' : $('#id_desa_cb').val(),
              'id_desa' : $('#id_desa_cb').val(),
              'rt' : $('#id_rt_lokasi').val(),
              'rw' : $('#id_rw_lokasi').val(),
...
$(document).on('click', '#btnHapusLokasiMusren', function() {
  ...
  $('#id_musren_lokasi_hapus').val(data.id_lokasi_musrencam);
  $('#nama_desa_hapus').text(data.nama_desa);

  $('#HapusLokasiMusrencam').modal('show');

});

$(document).on('click', '#btnDelLokasiMusrencam', function() {
    $.ajaxSetup({
       headers: { 'X-CSRF-Token' : $('meta[name=_token]').attr('content') }
    });
    ...
    $.ajax({
      type: 'post',
      url: 'musrencam/hapusMusrenCamLokasi',
      data: {
        '_token': $('input[name=_token]').val(),
        'id_lokasi_musrencam': $('#id_musren_lokasi_hapus').val()
      },
      success: function(data) {
        usulan_tbl.ajax.reload();
        if(data.status_pesan==1){
...
$(document).on('click', '#btnPostUsulanKec', function() {

  var data = usulan_tbl.row( $(this).parents('tr') ).data();

    $('#id_musrencam_posting').val(data.id_musrencam);
...
$('.modal-footer').on('click', '#btnPostProgram', function() {
      ...
      $.ajax({
          type: 'post',
          url: 'musrencam/postMusrenCam',
          data: {
              '_token': $('input[name=_token]').val(),
              'id_musrencam': $('#id_musrencam_posting').val(),
