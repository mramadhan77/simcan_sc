          ...
          <div class="modal-body">
            <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" onsubmit="return false;">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-3">
                  <input type="text" class="form-control number nomor" id="no_urut_indikatorKeg" disabled>
                </div>
              ...
              <div class="form-group">
                ...
                <label for="target_indikatorKeg_renja" class="col-sm-3 control-label" align='left'>Target Capaian Rancangan RKPD :</label>
                <div class="col-sm-3">
