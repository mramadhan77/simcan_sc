...
<?php $__env->startSection('content'); ?>
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-12">
        <?php
                $this->title = 'Dokumen Forum Perangkat Daerah';
      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <p><h2 class="panel-title">Dokumen Forum Perangkat Daerah</h2></p>
          </div>
                ...
                <form class="form-horizontal" role="form" autocomplete='off' action="#" method="" >
                  <div class="form-group">
                    <label for="tahun_rkpd" class="col-sm-2 control-label text-left" align='left'>Tahun Perencanaan :</label>
                      <div class="col-sm-2">                            
                          <input class="form-control text-center" type="text" id="tahun_rkpd_main" name="tahun_rkpd_main" value="<?php echo e(Session::get('tahun')); ?>" disabled style="text-align: center;">
                      </div>
                  </div>
                  <div class="form-group">
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-danger">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border text-danger" aria-hidden="true"></i>
                Yakin akan menghapus Dokumen Forum Perangkat Daerah dengan nomor dokumen: <strong><span class="ur_dokumen_del"></span></strong>  ?
                <br>
                <br>
                <strong>Catatan : Penghapusan dokumen ini akan menghapus data Forum Perangkat Daerah yang telah diproses !!!!</strong>
          </div>
        </div>
          <div class="modal-footer">
            <div class="ui-group-buttons">
...
<div id="StatusProgram" class="modal fade" role="dialog" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
            <h4 style="text-align: center;">Perubahan Status Dokumen Forum Perangkat Daerah</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="alert alert-success">
                <div>
                  ...
                  <p>Yakin akan melakukan proses <strong><i><span id="ur_status_dokumen_posting"></span></i></strong> pada Dokumen Forum Perangkat Daerah <strong><span id="ur_tahun_posting"></span></strong> ?</p>
                </div>
                <hr>
                <div>
...
$(document).on('click', '#btnAddDokumen', function() {
  ...
  if($('#id_unit').val()== -1){
    ...
    $('#btnDokumen').removeClass('editDokumen');
     ...
     $('.modal-title').text('Tambah Dokumen Forum Perangkat Daerah');
     $('.form-horizontal').show();

     $('#id_dokumen_rkpd').val(null);
     $('#tahun_rkpd').val(<?php echo e(Session::get('tahun')); ?>);
...
$(document).on('click', '#btnEditDokumen', function() {
  ...
  var data = dokumen_tbl.row( $(this).parents('tr') ).data();
      ...
      $('.modal-title').text('Ubah Dokumen Forum Perangkat Daerah');
      $('.form-horizontal').show();
