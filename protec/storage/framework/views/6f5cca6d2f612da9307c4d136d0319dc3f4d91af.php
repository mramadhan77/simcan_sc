    ...
    <div class="row">
      <div class="col-md-12">
        <?php
                ...
                $breadcrumb->add(['label' => 'APBD Pergeseran']);
                $breadcrumb->end();
            ?> 
    </div>
    </div>
      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <p><h2 class="panel-title">Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) - Pergeseran</h2></p>
          </div>
          ...
          <div class="panel-body">
                ...
                <div class='tabs-x tabs-above tab-bordered tabs-krajee'>                    
                  <div id="judul" class="alert alert-info col-md-12" ><b>Daftar Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) - Pergeseran</b></div>
                  <ul class="nav nav-tabs" role="tablist">
                      <li class="active"><a href="#dokumen" aria-controls="dokumen" role="tab" data-toggle="tab">Dokumen APBD</a></li>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal" autocomplete='off' action="" method="post" onsubmit="return false;">
          ...
          <input type="hidden" name="temp_tahun_rkpd" id="temp_tahun_rkpd" value="<?php echo e(Session::get('tahun')); ?>">      
          ...
          <div class="form-group">
            <label class="control-label col-sm-3" for="title">Dokumen PPAS Referensi :</label>
            <div class="col-sm-8">
...
<div id="HapusDokumen" class="modal fade" role="dialog" tabindex="-1" data-focus-on="input:first" data-backdrop="static">
    <div class="modal-dialog modal-xs">
      <div class="modal-content">
        <div class="modal-header">
            <h4>Hapus Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD)</h4>
        </div>
        <div class="modal-body">
            ...
            <div class="alert alert-danger">
              <i class="fa fa-exclamation-triangle fa-3x fa-pull-left fa-border text-danger" aria-hidden="true"></i>
                Yakin akan menghapus Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) dengan nomor dokumen: <strong><span class="ur_dokumen_del"></span></strong>  ?
                <br>
                <br>
                <strong>Catatan : Penghapusan dokumen ini akan menghapus data Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) yang telah diproses !!!!</strong>
          </div>
        </div>
          <div class="modal-footer">
            <div class="ui-group-buttons">
        ...
        <div class="modal-body">
            ...
            <div class="alert alert-success">
                <div>
                  ...
                  <p>Yakin akan melakukan proses <strong><i><span id="ur_status_dokumen_posting"></span></i></strong> pada Dokumen Anggaran Pendapatan dan Belanja Daerah (APBD) Tahun <strong><span id="ur_tahun_posting"></span></strong> ?</p>
                </div>
                <hr>
                <div>
...
<?php $__env->startSection('scripts'); ?>
    <script src="<?php echo e(asset('/protected/resources/views/apbd1/js/js_doku.js')); ?>"></script>
<?php $__env->stopSection(); ?>
