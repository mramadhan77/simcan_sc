...
$(document).ready(function() {
  ...
  var Visi = $('#tblVisi').DataTable( {
          ...
          language: {
                "decimal": ",",
                "thousands": "."},
          ajax: "<?php echo e(url('./rpjmd/visi')); ?>",
          columns: [
  ...
  <?php echo $__env->make('rpjmd.JsRpjmdTujuanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
...
tblSasaran = $('#tblSasaran').DataTable( {
  ...
  <?php echo $__env->make('rpjmd.JsRpjmdSasaranIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
...
$.ajax({
  ...
  <?php echo $__env->make('rpjmd.JsRpjmdProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
