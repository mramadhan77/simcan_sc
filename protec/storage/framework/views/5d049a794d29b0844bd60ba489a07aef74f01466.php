    ...
    <div class="container text-center">
        <div class="row">
            <div class="col-sm-12 col-md-12 col-lg-12">
                <h2 style="font-size: 40px;line-height: 60px;margin-bottom: 10px;font-weight: 900;"><span class="highlight">Laporan Forum OPD Tahunan</span></h2>
                <br>
            </div>
        </div>
...
<?php $__env->startSection('scripts'); ?>
  <script src="<?php echo e(asset('/protected/resources/views/report/js/js_cetak_forum.js')); ?>"></script>
<?php $__env->stopSection(); ?>
