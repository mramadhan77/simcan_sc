...
function loadSasaran($id_dokumen) {
  ...
  <?php echo $__env->make('kin.iku.iku_unit.JsIkuDokumen', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.iku.iku_unit.JsIkuSasaranIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.iku.iku_unit.JsIkuProgramIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
  <?php echo $__env->make('kin.iku.iku_unit.JsIkuKegiatanIndikator', array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>
