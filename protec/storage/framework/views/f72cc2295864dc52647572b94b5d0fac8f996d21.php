...
<?php $__env->startSection("content"); ?>
  <div class="container-fluid">
    <div class="row">
        <div class="col-md-12">
            <?php
                $this->title = "Data Program Pemda APBD Pergeseran";
      ...
      <div class="col-md-12">
        <div class="panel panel-info">
          <div class="panel-heading">
            <h2 class="panel-title">Daftar Program Pemda APBD Pergeseran</h2>
          </div>
          <div class="panel-body">
              <form name="" class="form-horizontal" role="form" autocomplete="off" action="" method="post">
                  <input type="hidden" name="_token" value="<?php echo e(csrf_token()); ?>">                  
                  <div class="form-group">
                    <label for="tahun_rkpd" class="col-sm-3 control-label text-left">Tahun Anggaran :</label>
                    <div class="col-sm-2"><input class="form-control text-center" type=text id="tahun_rkpd" name=tahun_rkpd value="<?php echo e(Session::get('tahun')); ?>" disabled></div>
                  </div>
                  <div class="form-group">
                      <label for="id_dokumen_keu" class="control-label col-sm-3 text-left" for="id_dokumen_keu">Nomor Dokumen Keuangan :</label>
                      <div class="col-sm-5"><select class="form-control id_dokumen_keu" name=id_dokumen_keu id="id_dokumen_keu"></select></div>
                  </div>
              </form>
              ...
              <table id="tblProgramRKPD" class="table display table-responsive table-striped compact table-bordered"  cellspacing="0" width="100%">
                        <thead>
                            <tr>
                                ...
                                <th rowspan="2" width="10%" style="text-align: center; vertical-align:middle">Pagu APBD Pergeseran</th>
...
<?php echo $__env->make("apbd1.program_rkpd", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make("apbd1.indikator_program_rkpd", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make("apbd1.urusan_program_rkpd", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make("apbd1.pelaksana_program_rkpd", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;

<?php echo $__env->make("apbd1.cariIndikator", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make("apbd1.cariProgramRPJMD", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make("apbd1.cariRefUnit", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;
<?php echo $__env->make("apbd1.StatusProgram", array_except(get_defined_vars(), array('__data', '__path')))->render(); ?>;

<?php $__env->stopSection(); ?>

<?php $__env->startSection("scripts"); ?>
    <script src="<?php echo e(asset('/protected/resources/views/apbd1/js/js_rkpd.js')); ?>"></script>
<?php $__env->stopSection(); ?>
