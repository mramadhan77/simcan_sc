      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          <form class="form-horizontal" role="form" autocomplete='off' action="" method="post" >
              ...
              <input type="hidden" class="form-control" id="id_indikator_program_renstra_edit" name="id_indikator_program_renstra_edit" readonly >
              <input type="hidden" class="form-control" id="thn_id_indikator_program_edit" name="thn_id_indikator_program_edit" readonly>
              <input type="hidden" class="form-control" id="id_program_renstra_indikator_edit" name="id_program_renstra_indikator_edit" readonly>
              ...
              <div class="form-group">
                  ...
                  <input type="hidden" id="id_indikator_sasaran_program_renstra" name="id_indikator_sasaran_program_renstra">
                  <span class="btn btn-primary btnCariIndiSasaranRenstra" id="btnCariIndiSasaranRenstra" name="btnCariIndiSasaranRenstra"><i class="fa fa-search fa-fw fa-lg"></i></span>
              </div>  
              <div class="form-group">
              ...
              <label class="col-sm-12" style="text-align: left;">Rincian Target Indikator Program Renstra :</label>
              <br>
