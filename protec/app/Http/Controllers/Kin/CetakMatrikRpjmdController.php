...
class CetakMatrikRpjmdController extends Controller
{
  ...
  public function printMatrikRpjmd($id_rpjmd)
  {
    ...
    foreach ($data_unit as $units){
        $html .='<div style="text-align: center; font-size:12px; font-weight: bold;">Matrik Rencana Pembangunan Jangka Menengah (RPJMD)<br>';
        $html .='<span style="text-align: center; font-size:14px; font-weight: bold;"> PERIODE '.$units->tahun_1.' - '.$units->tahun_5.'</span><br>';
        $html .='<span style="text-align: center; font-size:10px; font-weight: bold; font-style: italic"> PERDA Nomor : '.$units->no_perda.'</span></div>';
    };
    $html .='<br>';
