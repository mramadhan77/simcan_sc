...
class TrxApbdController extends Controller
{
   ...
   public function index(Request $request, Builder $htmlBuilder)
    ...
    public function getDataDokumen()
    {
         $getDataDokumen = DB::SELECT('SELECT (@id:=@id+1) as no_urut, a.id_dokumen_keu, a.jns_dokumen_keu, a.kd_dokumen_keu,a.id_perubahan, a.id_dokumen_ref, 
                    ...
                    WHERE a.jns_dokumen_keu = 1 AND a.kd_dokumen_keu=0 AND a.tahun_anggaran='.Session::get('tahun'));
        ...
        ->addColumn('action', function ($getDataDokumen) {
            ...
            <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        <li>
                            <a id="btnEditDokumen" class="dropdown-item"><i class="fa fa-pencil fa-fw fa-lg text-warning"></i> Ubah Dokumen APBD</a>
                        </li>
                        <li>
                            <a id="btnProsesLoad" class="dropdown-item"><i class="fa fa-refresh fa-fw fa-lg text-primary"></i> Load Data PPAS</a>
                        </li>  
                        <li>
                            <a id="btnLihatRekap" class="dropdown-item"><i class="fa fa-binoculars fa-fw fa-lg text-info"></i> RKAP Data APBD</a>
                        </li>  
                        <li>
                            <a id="btnPostingRkpd" class="dropdown-item"><i class="fa fa-check fa-fw fa-lg text-success"></i> Posting Dokumen APBD</a>
                        </li> 
                        <li>
                            <a id="btnKirimAPBD" class="dropdown-item"><i class="fa fa-paper-plane fa-fw fa-lg text-primary"></i> Kirim APBD</a>
                        </li>                         
                    </ul>
                </div>
            ';
            ...
            <div class="btn-group">
                    ...
                    <ul class="dropdown-menu dropdown-menu-right">
                        ...
                        <li>
                            <a id="btnPostingRkpd" class="dropdown-item"><i class="fa fa-times fa-fw fa-lg text-danger"></i> Un-Posting Dokumen APBD</a>
                        </li>  
                        <li>
                            <a id="btnKirimAPBD" class="dropdown-item"><i class="fa fa-paper-plane fa-fw fa-lg text-primary"></i> Kirim APBD</a>
                        </li>                           
...
public function getDataRekap(Request $req){
    ...
    public function importData(Request $req){
        ...
        if($dataProgrkpd == 0){
            ...
            id_satuan_output, status_data, sumber_data)
                ...
                b.tolok_ukur_indikator, b.target_rkpd, b.target_rkpd, b.indikator_input, COALESCE(b.target_input,0), b.id_satuan_input, b.indikator_output, b.id_satuan_output, 
                0, 0 FROM trx_anggaran_indikator AS b 
                ...
                if($dataUrusanrkpd == 0){
                    ...
                    if($dataPelaksanarkpd == 0){
                        ...
                        $dataProgpd=DB::INSERT('INSERT INTO trx_anggaran_program_pd (id_pelaksana_anggaran, kd_dokumen_keu, jns_dokumen_keu, id_perubahan, id_dokumen_keu, tahun_anggaran,
                            ...
                            SELECT c.id_pelaksana_anggaran, '.$req->kd_dokumen_keu.', '.$req->jns_dokumen_keu.', '.$req->id_perubahan.', '.$req->id_dokumen_rkpd.', z.tahun_anggaran, 
                                            ...
                                            if($dataAktivitas == 0){
                                                ...
                                                if($dataLokasi == 0){
                                                    ...
                                                    if($dataBelanja == 0){
                                                        ...
                                                        return response ()->json (['pesan'=>'Data Awal APBD Berhasil di-Load','status_pesan'=>'1']);
                                                    }
                                                } 
                                            } 
                                        }
    ...
    public function getDataDokReferensi(Request $req)
    {
        $dataDokumen = DB::SELECT('SELECT a.id_dokumen_keu, a.jns_dokumen_keu, a.kd_dokumen_keu,a.id_perubahan, a.id_dokumen_ref, 
            ...
            FROM trx_anggaran_dokumen AS a
            WHERE a.jns_dokumen_keu = 0 AND a.kd_dokumen_keu=0 AND a.tahun_anggaran = '.$req->tahun.' AND a.flag = 0');
    ...
    public function postDokumen(Request $req)
    {
        $cek = DB::SELECT('SELECT COUNT(id_dokumen_ref) AS jml FROM trx_anggaran_dokumen
            WHERE (jns_dokumen_keu = 0 OR jns_dokumen_keu = 1) AND kd_dokumen_keu <> 0 AND tahun_anggaran = '.$req->tahun_anggaran.'
        ...
        if($cek != null && $cek[0]->jml > 0 ){            
            ...
            if($data != 0){
                ...
                if($dataProg != 0){
                    ...
                    return response ()->json (['pesan'=>'Data Gagal Diposting (e1cprPD)','status_pesan'=>'0']);
                }
            } else {
                return response ()->json (['pesan'=>'Data Gagal Diposting (0cdrPD)','status_pesan'=>'0']);
            }
    ...
    public function PostAPBD()
    {

    }    

    public function PostUnit($id_unit)
    {
        //$url = 'http://localhost:8080/datasnap/rest/scapi/';
        // $url = 'http://172.31.31.31:81/datasnap/rest/scapi/';
        $url = env('URL_API_KEU','forge');
        $unit = DB::select('SELECT B.kd_urusan, B.kd_bidang, A.kd_unit FROM ref_unit AS A 
        ...
        if (count($unit) > 0) {
            foreach ($unit as $row) {
                ...
                else 
                {
                    if($getUrl['error'])
                    {
                        foreach ($getUrl['error'] as $key => $value) {
                            if (! is_array($value)) {
            ...
            return json_encode([ 'pesan' => $temp, 'status_pesan' => '1' ]);
        } else {
            return json_encode([
                'pesan' => 'tidak ada data yang akan diposting',
                'status_pesan' => '0'
            ]);
        }
    }
