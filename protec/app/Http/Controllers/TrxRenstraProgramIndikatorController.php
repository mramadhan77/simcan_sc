...
class TrxRenstraProgramIndikatorController extends Controller
{
    ...
    public function getIndikatorProgram($id_Program_renstra)
    {
        $indikatorProg=DB::SELECT('SELECT (@id:=@id+1) AS urut,a.thn_id, a.no_urut, a.id_program_renstra, a.id_indikator_program_renstra, 
        a.id_perubahan, a.kd_indikator, a.uraian_indikator_program_renstra,
        ...
        LEFT OUTER JOIN ref_satuan AS c ON b.id_satuan_output = c.id_satuan,(SELECT @id:=0) x  WHERE a.id_program_renstra='.$id_Program_renstra);
    ...
    public function getIndikatorSasaranRenstra($id_sasaran){
        $refindikator=DB::SELECT('SELECT (@id:=@id+1) as no_urut, a.id_indikator_sasaran_renstra, a.kd_indikator, 
        b.nm_indikator, b.id_satuan_output,c.uraian_satuan
            ...
            (SELECT @id:=0) x
            WHERE a.id_sasaran_renstra='.$id_sasaran);
    ...
    public function addIndikator(Request $request)
    {
        ...
        $messages =[
            ...
            'id_program_renstra.required'=> 'No Program Kosong',
            ...
            'id_indikator_sasaran_renstra.required' => 'Indikator Sasaran Kosong',
		];
		...
		if($validation->fails()) {
			...
			$data = new TrxRenstraProgramIndikator();
            $data->thn_id= $request->thn_id;
            $data->no_urut= $request->no_urut;
            $data->id_program_renstra= $request->id_program_renstra;
            $data->id_indikator_sasaran_renstra= $request->id_indikator_sasaran_renstra;            
            $data->id_perubahan= $request->id_perubahan;
            $data->kd_indikator= $request->kd_indikator;
            $data->uraian_indikator_program_renstra= $request->uraian_indikator_program_renstra;
    ...
    {
        $rules = [
            'id_indikator_program_renstra' => 'required',
            'thn_id' => 'required',
            'no_urut' => 'required',
            'id_program_renstra'=> 'required',
            'id_perubahan' => 'required',
        ...
        $messages =[
            'id_indikator_program_renstra.required' => 'Id Indikator Kosong',
            'thn_id.required' => 'Tahun Kosong',
            'no_urut.required' => 'No Urut Kosong',
            'id_program_renstra.required'=> 'No Program Kosong',           
            'id_indikator_sasaran_renstra.required' => 'Indikator Sasaran Kosong',
		...
		if($validation->fails()) {
            ...
            $data = TrxRenstraProgramIndikator::find($request->id_indikator_program_renstra);
            $data->thn_id= $request->thn_id;
            $data->no_urut= $request->no_urut;
            $data->id_program_renstra= $request->id_program_renstra;
            $data->id_indikator_sasaran_renstra= $request->id_indikator_sasaran_renstra;
    ...
    public function delIndikator(Request $request){
		...
		if($validation->fails()) {
            ...
            $data = TrxRenstraProgramIndikator::where('id_indikator_program_renstra',$request->id_indikator_program_renstra)->delete();
