...
class TrxRpjmdProgramPelaksana extends Model
{
    ...
    protected $fillable = ['thn_id','no_urut','id_urbid_rpjmd','id_pelaksana_rpjmd','id_unit','id_perubahan','pagu_tahun1','pagu_tahun2',
    'pagu_tahun3','pagu_tahun4','pagu_tahun5','sumber_data','created_at','updated_at'];
