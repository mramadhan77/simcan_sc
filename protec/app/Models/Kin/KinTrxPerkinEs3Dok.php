...
class KinTrxPerkinEs3Dok extends Model
{
    protected $table = 'kin_trx_perkin_es3_dok';
    protected $primaryKey = 'id_dokumen_perkin';
    protected $fillable = ['id_sotk_es3', 'tahun', 'no_dokumen', 'tgl_dokumen', 'tanggal_mulai', 'id_pegawai', 
